    ...
    <div class="">
                            ...
                            <div class="col-xs-3" id="tunai">
                                <div class="form-group">
                                    <label class="control-label" for="" name="CAPTION-INPUTPEMBAYARANTUNAI">Input Pembayaran
                                        Tunai</label>
                                    <input type="number" readonly id="input_tunai" class="form-control input-sm" name="input_tunai" autocomplete="off" placeholder="0" value="<?= round($header['delivery_order_nominal_tunai']) ?>">
                                </div>
                            </div>
            ...
            <div class="row" id="panel-customer" style="<?= $header['client_pt_id'] == '' ? 'display:none;' : '' ?>">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_nama]" id="deliveryorderdraft-delivery_order_kirim_nama" value="<?= $header['delivery_order_kirim_nama']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_alamat]" id="deliveryorderdraft-delivery_order_kirim_alamat" value="<?= $header['delivery_order_kirim_alamat']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_provinsi]" id="deliveryorderdraft-delivery_order_kirim_provinsi" value="<?= $header['delivery_order_kirim_provinsi']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kota]" id="deliveryorderdraft-delivery_order_kirim_kota" value="<?= $header['delivery_order_kirim_kota']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kecamatan]" id="deliveryorderdraft-delivery_order_kirim_kecamatan" value="<?= $header['delivery_order_kirim_kecamatan']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kelurahan]" id="deliveryorderdraft-delivery_order_kirim_kelurahan" value="<?= $header['delivery_order_kirim_kelurahan']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kodepos]" id="deliveryorderdraft-delivery_order_kirim_kodepos" value="<?= $header['delivery_order_kirim_kodepos']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_area]" id="deliveryorderdraft-delivery_order_kirim_area" value="<?= $header['delivery_order_kirim_area']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_telepon]" id="deliveryorderdraft-delivery_order_kirim_telepon" value="<?= $header['delivery_order_kirim_telp']; ?>" />
            ...
            <div class="row" id="panel-factory" style="<?= $header['pabrik_id'] == '' ? 'display:none;' : '' ?>">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_nama]" id="deliveryorderdraft-delivery_order_ambil_nama" value="<?= $header['delivery_order_ambil_nama']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_alamat]" id="deliveryorderdraft-delivery_order_ambil_alamat" value="<?= $header['delivery_order_ambil_alamat']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_provinsi]" id="deliveryorderdraft-delivery_order_ambil_provinsi" value="<?= $header['delivery_order_ambil_provinsi']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kota]" id="deliveryorderdraft-delivery_order_ambil_kota" value="<?= $header['delivery_order_ambil_kota']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kecamatan]" id="deliveryorderdraft-delivery_order_ambil_kecamatan" value="<?= $header['delivery_order_ambil_kecamatan']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kelurahan]" id="deliveryorderdraft-delivery_order_ambil_kelurahan" value="<?= $header['delivery_order_ambil_kelurahan']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kodepos]" id="deliveryorderdraft-delivery_order_ambil_kodepos" value="<?= $header['delivery_order_ambil_kodepos']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_telepon]" id="deliveryorderdraft-delivery_order_ambil_telepon" value="<?= $header['delivery_order_ambil_telp']; ?>" />
                        <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_area]" id="deliveryorderdraft-delivery_order_ambil_area" value="<?= $header['delivery_order_ambil_area']; ?>" />
        ...
        <div class="row" id="panel-sku">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div style="float: right">
                    <a href="<?= base_url('WMS/StatusDO/StatusDOMenu') ?>" class="btn btn-info"><i class="fa fa-reply"></i> <label name="CAPTION-KEMBALI">Kembali</label></a>
                </div>
            </div>
        </div>
    </div>
