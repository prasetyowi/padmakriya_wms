    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Pallete Number Generator</h3>
            </div>
            <!-- <div style="float: right">
                <button type="button" class="btn btn-dark" id=""><i class="fas fa-arrow-left"></i> <label
                        name="CAPTION-BACK">Kembali</label></button>
            </div> -->
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-8">
                                        <select name="perusahaan_sj" id="perusahaan_sj" class="form-control select2">
                                            ...
                                            <option value="<?= $val->client_wms_id ?>"><?= $val->client_wms_nama ?>
                                                <?php endforeach; ?>
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <div class="" style="float:right">
                        ...
                        <button disabled type="button" class="btn btn-primary"><i class="fa fa-print"></i>
