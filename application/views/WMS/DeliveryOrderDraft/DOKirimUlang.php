<div class="right_col" role="main">
	<div class="">
		...
		<?php foreach ($DOHeader as $header) : ?>
						...
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
									...
									<input readonly="readonly" type="text" id="deliveryorderdraft-delivery_order_draft_kode" class="form-control input-sm" name="DeliveryOrderDraft[delivery_order_draft_kode]" autocomplete="off" value="<?= $header['delivery_order_kode']; ?>">
									...
									<input readonly="readonly" type="hidden" id="deliveryorderdraft-delivery_order_draft_reff_id" class="form-control input-sm" name="DeliveryOrderDraft[delivery_order_draft_reff_id]" autocomplete="off" value="<?= $header['delivery_order_id']; ?>">
									<input readonly="readonly" type="hidden" id="deliveryorderdraft-delivery_order_draft_reff_no" class="form-control input-sm" name="DeliveryOrderDraft[delivery_order_draft_reff_no]" autocomplete="off" value="<?= $header['delivery_order_kode']; ?>">
							...
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
									...
									<select name="DeliveryOrderDraft[tipe_delivery_order_id]" class="input-sm form-control" id="deliveryorderdraft-tipe_delivery_order_id" disabled>
						...
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_buat_do">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_buat_do" class="form-control input-sm datepicker" name="DeliveryOrderDraft[delivery_order_draft_tgl_buat_do]" autocomplete="off" value="<?= $header['delivery_order_tgl_buat_do']; ?>">
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_expired_do">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_expired_do" class="form-control input-sm datepicker" name="DeliveryOrderDraft[delivery_order_draft_tgl_expired_do]" autocomplete="off" value="<?= $header['delivery_order_tgl_expired_do']; ?>">
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_surat_jalan">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_surat_jalan" class="form-control input-sm datepicker" name="DeliveryOrderDraft[delivery_order_draft_tgl_surat_jalan]" autocomplete="off" value="<?= $header['delivery_order_tgl_surat_jalan']; ?>">
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim" class="form-control input-sm datepicker" name="DeliveryOrderDraft[delivery_order_draft_tgl_rencana_kirim]" autocomplete="off" value="<?= $header['delivery_order_tgl_rencana_kirim']; ?>">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group field-deliveryorderdraft-client_wms_id">
									...
									<select id="deliveryorderdraft-client_wms_id" class="input-sm form-control select2" name="DeliveryOrderDraft[client_wms_id]" onchange="getCustomer()" disabled>
							...
							<div class="col-xs-6">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_keterangan">
									...
									<textarea rows="5" type="text" id="deliveryorderdraft-delivery_order_draft_keterangan" class="form-control input-sm" name="DeliveryOrderDraft[delivery_order_draft_keterangan]" autocomplete="off"><?= $header['delivery_order_keterangan'] ?></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_pembayaran">
									...
									<fieldset>
										<label>
											<input class="radio-payment-type" type="radio" name="DeliveryOrderDraft[delivery_order_draft_tipe_pembayaran]" id="deliveryorderdraft-delivery_order_draft_tipe_pembayaran" value="0" <?= (int)$header['delivery_order_tipe_pembayaran'] == 0 ? 'checked' : '' ?> onclick="reset_table_sku()" disabled> <label name="CAPTION-TUNAI">Tunai</label>
										</label>
									</fieldset>
									<fieldset>
										<label>
											<input class="radio-payment-type" type="radio" name="DeliveryOrderDraft[delivery_order_draft_tipe_pembayaran]" id="deliveryorderdraft-delivery_order_draft_tipe_pembayaran" value="1" <?= $header['delivery_order_tipe_pembayaran'] == 1 ? 'checked' : '' ?> onclick="reset_table_sku()" disabled> <label name="CAPTION-NONTUNAI">Non
												Tunai</label>
										</label>
									</fieldset>
								</div>
							...
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_layanan">
									...
									?>
										<fieldset>
											<label>
												<input class="radio-service-type" type="radio" id="deliveryorderdraft-delivery_order_draft_tipe_layanan" name="DeliveryOrderDraft[delivery_order_draft_tipe_layanan]" value="<?= $row['tipe_layanan_nama'] ?>" onclick="getCustomer();" <?= $header['delivery_order_tipe_layanan'] == $row['tipe_layanan_nama'] ? 'checked' : '' ?> disabled>
							...
							<div class="col-xs-3" id="tunai">
								<div class="form-group">
									<label class="control-label" for="" name="CAPTION-INPUTPEMBAYARANTUNAI">Input Pembayaran
										Tunai</label>
									<input type="number" id="input_tunai" class="form-control input-sm" name="input_tunai" autocomplete="off" placeholder="0" value="<?= $header['delivery_order_nominal_tunai'] ?>" disabled>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group">
									...
									<div id="hide-file">
										<a href="<?= base_url('assets/images/uploads/Invoice/') . $header['delivery_order_attachment'] ?>" target="_blank"><?= $header['delivery_order_attachment'] ?></a>
									</div>
			...
			<div class="row" id="panel-customer" style="<?= $header['client_pt_id'] == '' ? 'display:none;' : '' ?>">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_nama]" id="deliveryorderdraft-delivery_order_draft_kirim_nama" value="<?= $header['delivery_order_kirim_nama']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_alamat]" id="deliveryorderdraft-delivery_order_draft_kirim_alamat" value="<?= $header['delivery_order_kirim_alamat']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_provinsi]" id="deliveryorderdraft-delivery_order_draft_kirim_provinsi" value="<?= $header['delivery_order_kirim_provinsi']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_kota]" id="deliveryorderdraft-delivery_order_draft_kirim_kota" value="<?= $header['delivery_order_kirim_kota']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_kecamatan]" id="deliveryorderdraft-delivery_order_draft_kirim_kecamatan" value="<?= $header['delivery_order_kirim_kecamatan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_kelurahan]" id="deliveryorderdraft-delivery_order_draft_kirim_kelurahan" value="<?= $header['delivery_order_kirim_kelurahan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_kodepos]" id="deliveryorderdraft-delivery_order_draft_kirim_kodepos" value="<?= $header['delivery_order_kirim_kodepos']; ?>" />
						<!-- <input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_area]" id="deliveryorderdraft-delivery_order_draft_kirim_area" value="<?= $header['delivery_order_kirim_area']; ?>" /> -->
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_kirim_telepon]" id="deliveryorderdraft-delivery_order_draft_kirim_telepon" value="<?= $header['delivery_order_kirim_telp']; ?>" />
						...
						<div class="customer-info">
							<div class="row">
								...
								<div class="col-xs-4">
									...
									<select id="deliveryorderdraft-delivery_order_draft_kirim_area" name="DeliveryOrderDraft[delivery_order_draft_kirim_area]" class="form-control input-sm select2" style="width:100%;" disabled>
										<option value=""><label name="CAPTION-PILIH">Pilih</label></option>
										<?php foreach ($Area as $area) : ?>
											<option value="<?= $area['area_nama'] ?>" <?= $area['area_nama'] == $header['delivery_order_kirim_area'] ? 'selected' : '' ?>><?= $area['area_nama'] ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
			...
			<div class="row" id="panel-factory" style="<?= $header['principle_id'] == '' ? 'display:none;' : '' ?>">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
						...
						<input type="hidden" name="DeliveryOrderDraft[pabrik_id]" id="deliveryorderdraft-pabrik_id" value="<?= $header['principle_id']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_nama]" id="deliveryorderdraft-delivery_order_draft_ambil_nama" value="<?= $header['delivery_order_ambil_nama']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_alamat]" id="deliveryorderdraft-delivery_order_draft_ambil_alamat" value="<?= $header['delivery_order_ambil_alamat']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_provinsi]" id="deliveryorderdraft-delivery_order_draft_ambil_provinsi" value="<?= $header['delivery_order_ambil_provinsi']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_kota]" id="deliveryorderdraft-delivery_order_draft_ambil_kota" value="<?= $header['delivery_order_ambil_kota']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_kecamatan]" id="deliveryorderdraft-delivery_order_draft_ambil_kecamatan" value="<?= $header['delivery_order_ambil_kecamatan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_kelurahan]" id="deliveryorderdraft-delivery_order_draft_ambil_kelurahan" value="<?= $header['delivery_order_ambil_kelurahan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_kodepos]" id="deliveryorderdraft-delivery_order_draft_ambil_kodepos" value="<?= $header['delivery_order_ambil_kodepos']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_telepon]" id="deliveryorderdraft-delivery_order_draft_ambil_telepon" value="<?= $header['delivery_order_ambil_telp']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[delivery_order_draft_ambil_area]" id="deliveryorderdraft-delivery_order_draft_ambil_area" value="<?= $header['delivery_order_ambil_area']; ?>" />
						<div class="factory-info">
							<div class="row">
								<div class="col-xs-4">
									<label name="CAPTION-NAMA">Nama:</label>
									<div class="factory-name" value=""><?= $header['delivery_order_ambil_nama'] ?>
									</div>
								</div>
								<div class="col-xs-4">
									<label name="CAPTION-ALAMAT">Alamat:</label>
									<div class="factory-address" value="">
										<?= $header['delivery_order_ambil_alamat'] ?></div>
								</div>
								<div class="col-xs-4">
									<label name="CAPTION-AREA">Area:</label>
									<div class="factory-area" value=""><?= $header['delivery_order_ambil_area'] ?>
									</div>
								</div>
							</div>
						</div>
							...
							?>
								<tr id="row-<?= $i ?>" class="row-item">
									...
									<td class="text-center" style="width:10%">
										<select id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_tipe_stock" class="form-control sku-tipe-stock" disabled>
											<option value="">**<label name="CAPTION-PILIH">Pilih</label>**</option>
									...
									<td class="text-center" style="width:10%">
										<select id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_request_expdate" class="form-control sku-request-expdate" onchange="reqFilter(this.value,'<?= $i ?>')" disabled>
									...
									<td class="text-center" style="width:10%">
										<select id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_filter_expdatebulan" class="form-control sku-filter-expdatebulan" <?= $detail['sku_request_expdate'] == '0' ? 'disabled' : '' ?> disabled>
											<option value="">**<label name="CAPTION-PILIH">Pilih</label>**</option>
									...
									<td class="text-center"><input type="text" id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_keterangan" class="form-control sku-keterangan" value="<?= $detail['sku_keterangan']; ?>" disabled />
									</td>
									<td class="text-center"><input min="0" type="number" id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_qty" class="form-control sku-qty" value="<?= $detail['sku_qty']; ?>" disabled /></td>
									<!-- <td class="text-center">
