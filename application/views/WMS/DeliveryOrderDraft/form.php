							...
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
								...
								<select name="DeliveryOrderDraft[tipe_gudang]" class="input-sm form-control" id="deliveryorderdraft-tipe_gudang">
									...
									<?php foreach ($TipeGudang as $type) : ?>
										<option value="<?= $type['tipegudang_kode'] ?>" <?= $type['tipegudang_kode'] == 'GS_REG' ? 'selected' : '' ?>><?= $type['tipegudang_nama'] ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-xs-3">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_pembayaran">
								...
								<fieldset>
									<label>
										<input class="radio-payment-type" type="radio" name="DeliveryOrderDraft[delivery_order_draft_tipe_pembayaran]" id="deliveryorderdraft-delivery_order_draft_tipe_pembayaran" value="0" checked> <label name="CAPTION-TUNAI">Tunai</label>
									</label>
								</fieldset>
								<fieldset>
									<label>
										<input class="radio-payment-type" type="radio" name="DeliveryOrderDraft[delivery_order_draft_tipe_pembayaran]" id="deliveryorderdraft-delivery_order_draft_tipe_pembayaran" value="1"> <label name="CAPTION-NONTUNAI">Non Tunai</label>
									</label>
								</fieldset>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_layanan">
								...
								?>
									<fieldset>
										<label>
											<input class="radio-service-type" type="radio" id="deliveryorderdraft-delivery_order_draft_tipe_layanan" name="DeliveryOrderDraft[delivery_order_draft_tipe_layanan]" value="<?= $row['tipe_layanan_nama'] ?>" <?= $index_tipe == 0 ? 'Checked' : '' ?>> <?= $row['tipe_layanan_nama'] ?>
										</label>
									</fieldset>
								<?php
									$index_tipe++;
						...
						<div class="col-xs-3" id="tunai">
							...
							<div class="form-group">
								...
								<input type="text" id="input_so_eks" class="form-control input-sm" name="input_so_eks" autocomplete="off" placeholder="input dokumen so eksternal">
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" id="input_do_eks" class="form-control input-sm" name="input_do_eks" autocomplete="off" placeholder="input dokumen do eksternal">
							</div>
						</div>
					</div>
				</div>
