        ...
        <div class="page-title">
            ...
            <div style="float: right">
                <?php if ($Menu_Access["C"] == 1) : ?>
                    ...
                    <button class="btn-submit btn btn-primary" id="btnerrormsg" onclick="ErrorMsgDOMasal()"><i class="fa fa-message"></i> <span name="CAPTION-PESANERRORDOAPPROVE">Pesan Error DO Approve</span></button>
    ...
    <div class="modal-dialog" style="width:80%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="btn_save_pembatalan_do" onclick="handlerSavePembatalanDO()"><i class="fas fa-save"></i> <label name="CAPTION-BATALKAN">Batalkan</label></button>
...
<div class="modal fade" id="modalUbahKeDraft" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width:80%">
        ...
        <div class="modal-content">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label name="CAPTION-PRINCIPLE">Principle</label>
                                <select id="principleUbahKeDraft" name="principleUbahKeDraft" class="form-control select2">
                                    <option value=""><label name="CAPTION-SEMUA">Semua</label></option>
                                    <?php foreach ($Principle as $row) : ?>
                                        <option value="<?= $row['principle_id'] ?>"><?= $row['principle_kode'] ?></option>
                                    <?php endforeach; ?>
                        ...
                        <div class="col-xs-3">
                            <button class="btn btn-primary" id="btn_ubah_do_draft" onclick="handlerDataSearchUbahKeDraft()" style="margin-top: 24px;"><i class="fas fa-search"></i> <label name="CAPTION-CARI">Cari</label></button>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered" width="100%" id="tableDataUbahKeDraft">
                            <thead>
                                <tr class="bg-primary">
                                    ...
                                    <td class="text-center" style="color:white;"><strong><label name="CAPTION-NODO">No. DO</label></strong></td>
                                    <td class="text-center" style="color:white;"><strong><label name="CAPTION-NOSO">No. SO</label></strong></td>
                                    <td class="text-center" style="color:white;"><strong><label name="CAPTION-NOSOEKSTERNAL">No. SO External</label></strong></td>
                                    <td class="text-center" style="color:white;"><strong><label name="CAPTION-NAMACUSTOMER">Nama Customer</label></strong></td>
                                    <td class="text-center" style="color:white;"><strong><label name="CAPTION-ALAMATKIRIM">Alamat Kirim</label></strong></td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="btn_save_ubah_draft" onclick="handlerSaveUbahKeDraft()"><i class="fas fa-save"></i> <label name="CAPTION-Ubah">Ubah</label></button>
...
<div class="modal fade" id="modalEditDataDO" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width:80%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button class="btn btn-primary" id="btn_search_data_edit_do" name="btn_search_data_edit_do" onclick="handlerDataSearchEditDO()" style="margin-top: 24px;"><i class="fas fa-search"></i> <label name="CAPTION-CARI">Cari</label></button>
                        </div>
                        <div class="col-md-12" style="display: none;" id="fieldChangeAllDate">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label name="CAPTION-GANTIAKTUALTGL">Ganti Aktual Rencana Kirim Untuk
                                            Semua</label>
                                        <input type="date" name="allChangeRencanaKirim" id="allChangeRencanaKirim" class="form-control" value="" onchange="handlerAllChangeRencanaKirim(this.value)">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label name="CAPTION-TIPE">Tipe</label>
                                    <select id="allChangeTipe" name="allChangeTipe" class="form-control" onchange="handlerAllChangeTipe(this.value)">
                                ...
                                <div class="col-md-3">
                                    <label name="CAPTION-TIPEGUDANG">Tipe Gudang</label>
                                    <select id="allChangeTipeGudang" name="allChangeTipeGudang" class="form-control" onchange="handlerAllChangeTipeGudang(this.value)">
                                        <option value=""><label name="CAPTION-PILIH">Pilih</label></option>
                                        <?php foreach ($TipeGudang as $type) : ?>
                                            <option value="<?= $type['tipegudang_kode'] ?>"><?= $type['tipegudang_nama'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <thead>
                                <tr class="bg-primary">
                                    ...
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-NODO">No. DO</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-NOSO">No. SO</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-NOSOEKSTERNAL">No. SO External</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-NAMACUSTOMER">Nama Customer</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-ALAMATKIRIM">Alamat Kirim</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-AREA">Area</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-STATUS">Status</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-TANGGALRENCANAKIRIM">Tanggal Rencana Kirim</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-TIPE">Tipe</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white;">
                                        <strong><label name="CAPTION-TIPEGUDANG">Tipe Gudang</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white; background-color: #EB8317">
                                        <strong><label name="CAPTION-UBAHTANGGALRENCANAKIRIM">Ubah Tanggal Rencana Kirim</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white; background-color: #EB8317">
                                        <strong><label name="CAPTION-UBAHTIPE">Ubah Tipe</label></strong>
                                    </td>
                                    <td class="text-center" style="color:white; background-color: #EB8317">
                                        <strong><label name="CAPTION-UBAHTIPEGUDANG">Ubah Tipe Gudang</label></strong>
                                    </td>
                                </tr>
                            </thead>
                            <tbody></tbody>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="btn_save_edit_do" name="btn_save_edit_do" onclick="handlerSaveEditDO()"><i class="fas fa-save"></i>
...
<div class="modal fade" id="modal_response_message_ubah_do" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 80%;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title"><label name="CAPTION-PESANERRORDOUBAHDRAFT">Pesan Error DO Ubah Draft</label></h4>
            </div>
            <div class="modal-body">
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <table class="table table-bordered" id="table_response_message_ubah_do" style="width:100%;">
                                <thead>
                                    <tr class="bg-primary">
                                        <th style="text-align: center; vertical-align: middle;color:white;">#</th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-STATUS">Status</th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-ERRORMESSAGE">Error Message</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-danger" onclick="CloseResponseMessageUbahDo()"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="modal_response_message_pembatalan_do" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 80%;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title"><label name="CAPTION-PESANERRORDOUBAHDRAFT">Pesan Error DO Ubah Draft</label></h4>
            ...
            <div class="modal-body">
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <table class="table table-bordered" id="table_response_message_pembatalan_do" style="width:100%;">
                                <thead>
                                    <tr class="bg-primary">
                                        <th style="text-align: center; vertical-align: middle;color:white;">#</th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-STATUS">Status</th>
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-danger" onclick="CloseResponseMessagePembatalanDO()"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
            </div>
        </div>
    </div>
</div>