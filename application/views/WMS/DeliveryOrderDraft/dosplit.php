								...
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
									...
									<select name="DeliveryOrderDraft[tipe_delivery_order_id]" class="input-sm form-control" id="deliveryorderdraft-tipe_delivery_order_id">
										...
										<?php foreach ($TipeDeliveryOrder as $type) : ?>
											<option value="<?= $type['tipe_delivery_order_id'] ?>" <?= $type['tipe_delivery_order_id'] == 'ADF55030-9802-4C27-9658-F9D37AA01F95' ? 'selected' : '' ?>>
							...
							<!-- <?php $arr_sku = array();
								...
								?>
									<tr id="row-<?= $i ?>" class="row-item">
										...
										<td class="text-center"><input readonly min="0" type="number" id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_qty" class="form-control sku-qty" value="<?= $detail['sku_qty']; ?>" onchange="UpdateTotalHarga('<?= $i ?>')" /></td>
										<td class="text-center"><input min="0" type="number" id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_qty_ambil" class="form-control sku-qty-ambil" value="0" /></td>
										// <td class="text-center">
											<?php
