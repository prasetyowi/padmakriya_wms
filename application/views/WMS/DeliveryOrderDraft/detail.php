                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
                                    ...
                                    <select name="DeliveryOrderDraft[tipe_gudang]" class="input-sm form-control" id="deliveryorderdraft-tipe_gudang" disabled>
                        ...
                        <div class="row">
                                    ...
                                    <fieldset>
                                        <label>
                                            <input class="radio-payment-type" type="radio"
                                                ...
                                                <?= $header['delivery_order_draft_tipe_pembayaran'] == 0 ? 'checked' : '' ?> disabled> <label
                                    ...
                                    <fieldset>
                                        <label>
                                            <input class="radio-payment-type" type="radio"
                                                ...
                                                <?= $header['delivery_order_draft_tipe_pembayaran'] == 1 ? 'checked' : '' ?> disabled> <label name="CAPTION-NONTUNAI">Non Tunai</label>
                                        </label>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-3" id="tunai">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled id="input_so_eks" class="form-control input-sm" name="input_so_eks" autocomplete="off" placeholder="input dokumen so eksternal" value="<?= $header['so_eksternal_no'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled id="input_do_eks" class="form-control input-sm" name="input_do_eks" autocomplete="off" placeholder="input dokumen do eksternal" value="<?= $header['do_eksternal_no'] ?>">
                                </div>
                            </div>
                        </div>
                    </div>
