                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-penerimaanpenjualan-karyawan_id">
                                    ...
                                    <select id="penerimaanpenjualan-karyawan_id" class="form-control select2" name="penerimaanpenjualan[karyawan_id]" disabled>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-penerimaanpenjualan-penerimaan_penjualan_kode">
                                    ...
                                    <input readonly="readonly" type="text" id="penerimaanpenjualan-penerimaan_penjualan_kode" class="form-control" name="penerimaanpenjualan[penerimaan_penjualan_kode]" autocomplete="off" placeholder="autogenerate" value="<?= $header['penerimaan_penjualan_kode'] ?>">
                                    <input type="hidden" id="penerimaanpenjualan-penerimaan_penjualan_id" class="form-control" name="penerimaanpenjualan[penerimaan_penjualan_id]" autocomplete="off" placeholder="autogenerate" value="<?= $header['penerimaan_penjualan_id'] ?>">
                                </div>
                            </div>
                            <div class="col-xs-6">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-penerimaanpenjualan-client_wms_id">
                                    ...
                                    <input readonly="readonly" type="text" id="penerimaanpenjualan-penerimaan_penjualan_tgl" class="form-control datepicker" name="penerimaanpenjualan[penerimaan_penjualan_tgl]" autocomplete="off" value="<?= $header['penerimaan_penjualan_tgl'] ?>">
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-penerimaanpenjualan-depo_detail_id">
                                    ...
                                    <select id="penerimaanpenjualan-depo_detail_id" class="form-control select2" name="penerimaanpenjualan[depo_detail_id]" disabled>
