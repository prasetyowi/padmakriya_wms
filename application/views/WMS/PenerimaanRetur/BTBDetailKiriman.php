    ...
    <div class="">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="form-group field-penerimaanpenjualan-delivery_order_batch_kode">
                                <label class="control-label" for="penerimaanpenjualan-delivery_order_batch_kode"
                                    name="CAPTION-NOFDJR">No FDJR</label>
                                <input readonly="readonly" type="text"
                                    id="penerimaanpenjualan-delivery_order_batch_kode" class="form-control"
                                    name="penerimaanpenjualan[delivery_order_batch_kode]" autocomplete="off"
                                    value="<?= $header['delivery_order_batch_kode'] ?>">
                                <input readonly="readonly" type="hidden"
                                    id="penerimaanpenjualan-delivery_order_batch_id" class="form-control"
                                    name="penerimaanpenjualan[delivery_order_batch_id]" autocomplete="off"
                                    value="<?= $header['delivery_order_batch_id'] ?>">
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="form-group field-penerimaanpenjualan-delivery_order_kode">
                                <label class="control-label" for="penerimaanpenjualan-delivery_order_kode"
                                ...
                                <textarea name="penerimaanpenjualan-delivery_order_kode"
                                    id="penerimaanpenjualan-delivery_order_kode" class="form-control"
                                    disabled><?= $do_kode ?></textarea>
                                <input readonly="readonly" type="text" id="penerimaanpenjualan-delivery_order_id"
                                    class="form-control" name="penerimaanpenjualan[delivery_order_id]"
                                    autocomplete="off" value="<?= $do_id ?>">
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="form-group field-penerimaanpenjualan-delivery_order_kode">
                                <label class="control-label" for="penerimaanpenjualan-sales_order_no_po"
                                    name="CAPTION-NOSOEKSTERNAL">No SO External</label>
                                ...
                                <textarea name="penerimaanpenjualan-sales_order_no_po"
                                    id="penerimaanpenjualan-sales_order_no_po" class="form-control"
                                    disabled><?= $no_so ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanpenjualan-client_wms_id">
                                <label for="penerimaanpenjualan-client_wms_id" class="control-label"
                                    name="CAPTION-PERUSAHAAN">Perusahaan</label>
                                <select id="penerimaanpenjualan-client_wms_id" class="form-control select2"
                                    name="penerimaanpenjualan[client_wms_id]" disabled>
                  ...
                  <select id="penerimaanpenjualan-principle_id" class="form-control select2" name="penerimaanpenjualan[principle_id]" onchange="GetCheckerByPrinciple(this.value)">
                    ...
                    <?php endforeach; ?>
                        ...
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanpenjualan-karyawan_id">
                                <label for="penerimaanpenjualan-karyawan_id" class="control-label"
                                    name="CAPTION-CHECKER">Checker</label>
                                <select id="penerimaanpenjualan-karyawan_id" class="form-control select2"
                                    name="penerimaanpenjualan[karyawan_id]"
                                    <?= $header['karyawan_id'] != '' ? 'disabled' : ''; ?>>
                                    <?php foreach ($Checker as $row) : ?>
                                    <option value="<?= $row['karyawan_id'] ?>"
                                        <?= $header['karyawan_id'] == $row['karyawan_id'] ? 'selected' : ''; ?>>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanpenjualan-penerimaan_penjualan_kode">
                                <label for="penerimaanpenjualan-penerimaan_penjualan_kode" class="control-label"
                                    name="CAPTION-NOBTB">No BTB</label>
                                <input readonly="readonly" type="text"
                                    id="penerimaanpenjualan-penerimaan_penjualan_kode" class="form-control"
                                    name="penerimaanpenjualan[penerimaan_penjualan_kode]" autocomplete="off"
                                    placeholder="autogenerate" value="">
                                <input type="text" id="penerimaanpenjualan-penerimaan_penjualan_id" class="form-control"
                                    name="penerimaanpenjualan[penerimaan_penjualan_id]" autocomplete="off"
                                    placeholder="autogenerate" value="<?= $header['penerimaan_penjualan_id'] ?>">
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanpenjualan-penerimaan_tipe">
                                <label class="control-label" for="penerimaanpenjualan-penerimaan_tipe"
                                    name="CAPTION-TIPE">Tipe BTB</label>
                                <textarea name="penerimaanpenjualan-penerimaan_tipe"
                                    id="penerimaanpenjualan-penerimaan_tipe" name="penerimaanpenjualan[penerimaan_tipe]"
                                    class="form-control" disabled><?= $do_status ?></textarea>
                                <input readonly="readonly" type="hidden" id="penerimaanpenjualan-tipe_delivery_order"
                                    class="form-control" name="penerimaanpenjualan[penerimaan_tipe]" autocomplete="off"
                                    value="<?= $do_tipe_nama ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanpenjualan-client_wms_id">
                                <label for="penerimaanpenjualan-client_wms_id" class="control-label"
                                    name="CAPTION-TGLBTB">Tanggal BTB</label>
                                <input type="text" id="penerimaanpenjualan-penerimaan_penjualan_tgl"
                                    class="form-control datepicker" name="penerimaanpenjualan[penerimaan_penjualan_tgl]"
                                    autocomplete="off" value="<?= $header['penerimaan_penjualan_tgl'] ?>" readonly>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanpenjualan-depo_detail_id">
                                <label for="penerimaanpenjualan-depo_detail_id" class="control-label"
                                    name="CAPTION-GUDANGPENERIMA">Gudang Penerima</label>
                                <select id="penerimaanpenjualan-depo_detail_id" class="form-control select2"
                                    name="penerimaanpenjualan[depo_detail_id]" disabled>
                                    <!-- <option value="">** <label name="CAPTION-PILIH">Pilih</label> **</option> -->
                                    <?php foreach ($Gudang as $row) : ?>
                                    <option value="<?= $row['depo_detail_id'] ?>"
                                        <?= $header['depo_detail_id'] == $row['depo_detail_id'] ? 'selected' : ''; ?>>
        ...
        <div class="row" style="margin-bottom:10px;margin-left:5px;margin-right:5px;">
            <div class="panel panel-default col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" id="viewpalletdoretur">
                <div class="panel-heading" style="margin-left:-10px;margin-right:-10px;"><span
                        name="CAPTION-PALLET">Pallet</span></div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary" id="btn-detail-pallet-do-retur"
                                        style="border:none;background:transparent"
                                        onClick="ViewPallet2('<?= $detail['pallet_id'] ?>')"><i
        ...
        <div class="row" style="margin-bottom:10px;margin-left:5px;margin-right:5px;">
            <div class="panel panel-default col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="viewdetailpallet"
                style="display: none;">
                        ...
                        <table id="tablepalletdetail" width="100%" class="table table-bordered">
                            <thead>
                                <tr class="bg-info">
                                    ...
                                    <th class="text-center"><span name="CAPTION-SKUKEMASAN">Kemasan</span></th>
                                    <th class="text-center"><span name="CAPTION-SKUSATUAN">Satuan</span></th>
                                    <th class="text-center"><span name="CAPTION-CAPTION-SKUREQEXPDATE">Exp Date</span>
                                    </th>
            ...
            <div class="row pull-right" style="margin-top:20px;">
                ...
                <a href="<?php echo base_url() ?>WMS/PenerimaanRetur/ProsesBTBMenu/?delivery_order_batch_id=<?= $dob_id; ?>"
