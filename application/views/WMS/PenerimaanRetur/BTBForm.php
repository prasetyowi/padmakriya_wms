	...
	<div class="">
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<div class="form-group field-penerimaanpenjualan-delivery_order_kode">
									...
									<input readonly="readonly" type="hidden" id="penerimaanpenjualan-delivery_order_id" class="form-control" name="penerimaanpenjualan[delivery_order_id]" autocomplete="off" value="<?= $header['delivery_order_id'] ?>">
								</div>
							</div>
							<div class="col-xs-4">
								<div class="form-group field-penerimaanpenjualan-delivery_order_kode">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group field-penerimaanpenjualan-penerimaan_tipe">
									...
									<input readonly="readonly" type="text" id="penerimaanpenjualan-penerimaan_tipe" class="form-control" name="penerimaanpenjualan[penerimaan_tipe]" autocomplete="off" value="<?= $header['do_status'] ?>">
									<input readonly="readonly" type="hidden" id="penerimaanpenjualan-tipe_delivery_order" class="form-control" name="penerimaanpenjualan[penerimaan_tipe]" autocomplete="off" value="<?= $header['tipe_delivery_order_nama'] ?>">
								</div>
							</div>
						</div>
						<div class="row">
								...
								foreach ($DODetail as $detail) : ?>
									<tr>
										...
										<td class="text-center">
											<select name="kondisiBarang" id="kondisiBarang" class="form-control select2">
												<option value="">--Pilih Kondisi Barang--</option>
												<option <?= $detail['kondisi_barang'] != null && $detail['kondisi_barang'] == 'Bagus' ? 'selected' : '' ?> value="Bagus,<?= $detail['delivery_order_id'] ?>,<?= $detail['sku_id'] ?>">Bagus</option>
												<option <?= $detail['kondisi_barang'] != null && $detail['kondisi_barang'] == 'Rusak' ? 'selected' : '' ?> value="Rusak,<?= $detail['delivery_order_id'] ?>,<?= $detail['sku_id'] ?>">Rusak</option>
											</select>
										</td>
									</tr>
							<?php $no++;
		...
		<div class="row" style="margin-bottom:10px;margin-left:5px;margin-right:5px;">
			...
			<div class="row pull-right" style="margin-top:20px;">
				...
				<a href="<?php echo base_url() ?>WMS/PenerimaanRetur/ProsesBTBMenu/?delivery_order_batch_id=<?= $delivery_order_batch_id; ?>&delivery_order_id=<?= $delivery_order_id; ?>" type="button" id="btn_back" class="btn btn-danger"><i class="fa fa-undo"></i> <span name="CAPTION-BACK">Kembali</span></a>
			</div>
		</div>
	</div>
</div>
