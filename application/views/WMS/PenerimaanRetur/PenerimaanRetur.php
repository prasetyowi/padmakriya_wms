   ...
   <div class="">
      <div class="page-title">
         <div class="title_left">
            <h3 name="CAPTION-130005014">Penerimaan Retur</h3>
         </div>
      </div>
      <div class="clearfix"></div>
      <div class="panel panel-default">
         <div class="panel-heading"><label name="CAPTION-PENCARIANSURATTUGASPENGIRIMAN">Pencarian Surat Tugas Pengiriman</label></div>
         <div class="panel-body form-horizontal form-label-left">
            <div class="row">
               <div class="col-lg-12">
                  <div class="form-group">
                     <label class="col-form-label col-md-2 col-sm-2 label-align" name="CAPTION-TANGGALFDJR">Tanggal FDJR</label>
                     <div class="col-md-6 col-sm-6">
                        <input type="text" id="filter_fdjr_date" class="form-control" name="filter_fdjr_date" value="" />
                     </div>
                  </div>
                  <div class="form-group">
                     <label class="col-form-label col-md-2 col-sm-2 label-align" name="CAPTION-NOFDJR">No FDJR</label>
                     <div class="col-md-6 col-sm-6">
