                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-penerimaanpenjualan-penerimaan_tipe">
                                    ...
                                    <input readonly="readonly" type="hidden" id="penerimaanpenjualan-tipe_delivery_order" class="form-control" name="penerimaanpenjualan[penerimaan_tipe]" autocomplete="off" value="<?= $do_tipe_nama ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
