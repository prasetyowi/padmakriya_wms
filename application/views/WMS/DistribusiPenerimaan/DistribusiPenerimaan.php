  ...
  <div class="">
    <div class="page-title">
      ...
      <div style="float: right">
        <button type="button" class="btn btn-success" id="simpan"><i class="fas fa-save"></i> Simpan</button>
        <a href="<?= base_url('WMS/DistribusiPenerimaan/DistribusiPenerimaanMenu') ?>" class="btn btn-dark"><i class="fas fa-arrow-left"></i> Kembali</a>
      </div>
    </div>
    ...
    <!-- form data -->
    <?php $this->load->view("WMS/DistribusiPenerimaan/component/form") ?>

    <!-- list scan data -->
    <?php $this->load->view("WMS/DistribusiPenerimaan/component/scan") ?>

    <!-- detail data pallet -->
    <?php $this->load->view("WMS/DistribusiPenerimaan/component/modal_detail/index") ?>
