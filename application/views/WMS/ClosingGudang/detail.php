						...
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
									...
									<input readonly="readonly" type="text" id="deliveryorderdraft-delivery_order_draft_kode" class="form-control input-sm" name="DeliveryOrderDraft[_delivery_order_draft_kode]" autocomplete="off" value="<?= $header['delivery_order_draft_kode']; ?>" readonly>
									<input readonly="readonly" type="hidden" id="deliveryorderdraft-delivery_order_draft_id" class="form-control input-sm" name="DeliveryOrderDraft[_delivery_order_draft_id]" autocomplete="off" value="<?= $header['delivery_order_draft_id']; ?>">
						...
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_buat_do">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_buat_do" class="form-control input-sm datepicker" name="DeliveryOrderDraft[_delivery_order_draft_tgl_buat_do]" autocomplete="off" value="<?= $header['delivery_order_draft_tgl_buat_do']; ?>" readonly>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_expired_do">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_expired_do" class="form-control input-sm datepicker" name="DeliveryOrderDraft[_delivery_order_draft_tgl_expired_do]" autocomplete="off" value="<?= $header['delivery_order_draft_tgl_expired_do']; ?>" readonly>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_surat_jalan">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_surat_jalan" class="form-control input-sm datepicker" name="DeliveryOrderDraft[_delivery_order_draft_tgl_surat_jalan]" autocomplete="off" value="<?= $header['delivery_order_draft_tgl_surat_jalan']; ?>" readonly>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim">
									...
									<input type="text" id="deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim" class="form-control input-sm datepicker" name="DeliveryOrderDraft[_delivery_order_draft_tgl_rencana_kirim]" autocomplete="off" value="<?= $header['delivery_order_draft_tgl_rencana_kirim']; ?>" readonly>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_keterangan">
									...
									<textarea rows="5" type="text" id="deliveryorderdraft-delivery_order_draft_keterangan" class="form-control input-sm" name="DeliveryOrderDraft[_delivery_order_draft_keterangan]" autocomplete="off" readonly><?= $header['delivery_order_draft_keterangan'] ?></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_pembayaran">
									...
									<fieldset>
										<label>
											<input class="radio-payment-type" type="radio" name="DeliveryOrderDraft[_delivery_order_draft_tipe_pembayaran]" id="deliveryorderdraft-delivery_order_draft_tipe_pembayaran" value="0" <?= $header['delivery_order_draft_tipe_pembayaran'] == 0 ? 'checked' : '' ?> onclick="reset_table_sku()" disabled> <label name="CAPTION-TUNAI">Tunai</label>
										</label>
									</fieldset>
									<fieldset>
										<label>
											<input class="radio-payment-type" type="radio" name="DeliveryOrderDraft[_delivery_order_draft_tipe_pembayaran]" id="deliveryorderdraft-delivery_order_draft_tipe_pembayaran" value="1" <?= $header['delivery_order_draft_tipe_pembayaran'] == 1 ? 'checked' : '' ?> onclick="reset_table_sku()" disabled> <label name="CAPTION-NONTUNAI">Non
												Tunai</label>
										</label>
									</fieldset>
								</div>
							...
							<div class="col-xs-3">
								<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_layanan">
									...
									?>
										<fieldset>
											<label>
												<input class="radio-service-type" type="radio" id="deliveryorderdraft-delivery_order_draft_tipe_layanan" name="DeliveryOrderDraft[_delivery_order_draft_tipe_layanan]" value="<?= $row['tipe_layanan_nama'] ?>" onclick="getCustomer();" <?= $header['delivery_order_draft_tipe_layanan'] == $row['tipe_layanan_nama'] ? 'checked' : '' ?> disabled> <?= $row['tipe_layanan_nama'] ?>
											</label>
										</fieldset>
									<?php
										$index_tipe++;
							...
							<div class="col-xs-3" id="tunai">
								<div class="form-group">
									<label class="control-label" for="" name="CAPTION-INPUTPEMBAYARANTUNAI">Input Pembayaran
										Tunai</label>
									<input type="number" readonly id="input_tunai" class="form-control input-sm" name="input_tunai" autocomplete="off" placeholder="0" value="<?= round($header['delivery_order_draft_nominal_tunai']) ?>">
								</div>
							</div>
			...
			<div class="row" id="panel-customer" style="<?= $header['client_pt_id'] == '' ? 'display:none;' : '' ?>">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<input type="hidden" name="DeliveryOrderDraft[_client_pt_id]" id="deliveryorderdraft-client_pt_id" value="<?= $header['client_pt_id']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_nama]" id="deliveryorderdraft-delivery_order_draft_kirim_nama" value="<?= $header['delivery_order_draft_kirim_nama']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_alamat]" id="deliveryorderdraft-delivery_order_draft_kirim_alamat" value="<?= $header['delivery_order_draft_kirim_alamat']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_provinsi]" id="deliveryorderdraft-delivery_order_draft_kirim_provinsi" value="<?= $header['delivery_order_draft_kirim_provinsi']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_kota]" id="deliveryorderdraft-delivery_order_draft_kirim_kota" value="<?= $header['delivery_order_draft_kirim_kota']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_kecamatan]" id="deliveryorderdraft-delivery_order_draft_kirim_kecamatan" value="<?= $header['delivery_order_draft_kirim_kecamatan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_kelurahan]" id="deliveryorderdraft-delivery_order_draft_kirim_kelurahan" value="<?= $header['delivery_order_draft_kirim_kelurahan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_kodepos]" id="deliveryorderdraft-delivery_order_draft_kirim_kodepos" value="<?= $header['delivery_order_draft_kirim_kodepos']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_area]" id="deliveryorderdraft-delivery_order_draft_kirim_area" value="<?= $header['delivery_order_draft_kirim_area']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_kirim_telepon]" id="deliveryorderdraft-delivery_order_draft_kirim_telepon" value="<?= $header['delivery_order_draft_kirim_telp']; ?>" />
			...
			<div class="row" id="panel-factory" style="<?= $header['pabrik_id'] == '' ? 'display:none;' : '' ?>">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<input type="hidden" name="DeliveryOrderDraft[_pabrik_id]" id="deliveryorderdraft-pabrik_id" value="<?= $header['pabrik_id']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_nama]" id="deliveryorderdraft-delivery_order_draft_ambil_nama" value="<?= $header['delivery_order_draft_ambil_nama']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_alamat]" id="deliveryorderdraft-delivery_order_draft_ambil_alamat" value="<?= $header['delivery_order_draft_ambil_alamat']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_provinsi]" id="deliveryorderdraft-delivery_order_draft_ambil_provinsi" value="<?= $header['delivery_order_draft_ambil_provinsi']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_kota]" id="deliveryorderdraft-delivery_order_draft_ambil_kota" value="<?= $header['delivery_order_draft_ambil_kota']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_kecamatan]" id="deliveryorderdraft-delivery_order_draft_ambil_kecamatan" value="<?= $header['delivery_order_draft_ambil_kecamatan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_kelurahan]" id="deliveryorderdraft-delivery_order_draft_ambil_kelurahan" value="<?= $header['delivery_order_draft_ambil_kelurahan']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_kodepos]" id="deliveryorderdraft-delivery_order_draft_ambil_kodepos" value="<?= $header['delivery_order_draft_ambil_kodepos']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_telepon]" id="deliveryorderdraft-delivery_order_draft_ambil_telepon" value="<?= $header['delivery_order_draft_ambil_telp']; ?>" />
						<input type="hidden" name="DeliveryOrderDraft[_delivery_order_draft_ambil_area]" id="deliveryorderdraft-delivery_order_draft_ambil_area" value="<?= $header['delivery_order_draft_ambil_area']; ?>" />
								...
								<tr id="row-<?= $i ?>" class="row-item">
									...
									<td class="text-center">
										<select id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_request_expdate" class="form-control sku-request-expdate" onchange="reqFilter(this.value,'<?= $i ?>')" disabled>
											<option value="0" <?= $detail['sku_request_expdate'] == '0' ? 'selected' : '' ?>><label name="CAPTION-TIDAK">Tidak</label>
											</option>
									...
									<td class="text-center"><input type="text" id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_keterangan" class="form-control sku-keterangan" value="<?= $detail['sku_keterangan']; ?>" readonly /></td>
									<td class="text-center"><input type="number" id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_qty" class="form-control sku-qty" value="<?= $detail['sku_qty']; ?>" readonly /></td>
								</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
