						...
						<div class="row">
							...
							<div class="col-xs-4">
								<div class="form-group field-TrAbacus-tr_abacus_kode">
									...
									<input type="date" id="TrAbacus-tr_abacus_tanggal" class="form-control" name="TrAbacus[tr_abacus_tanggal]" autocomplete="off" value="<?= $header['tr_abacus_tanggal'] ?>">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-4">
								<div class="form-group field-TrAbacus-tr_abacus_reff_kode">
									...
									<input type="text" id="TrAbacus-tr_abacus_reff_kode" class="form-control" name="TrAbacus[tr_abacus_reff_kode]" autocomplete="off" value="<?= $header['tr_abacus_reff_kode'] ?>">
								</div>
							</div>
							<div class="col-xs-4">
								<div class="form-group field-TrAbacus-tr_abacus_keterangan">
									...
									<input type="text" id="TrAbacus-tr_abacus_keterangan" class="form-control" name="TrAbacus[tr_abacus_keterangan]" autocomplete="off" value="<?= $header['tr_abacus_keterangan'] ?>">
								</div>
							</div>
							<div class="col-xs-4">
		...
		<div class="row" id="panel-sku">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div style="float: right">
					...
					<button class="btn-submit btn btn-primary" id="btn_konfirmasi" onclick="confirmData()"><i class="fa fa-check"></i> <span name="CAPTION-KONFIRMASI">Konfirmasi</span></button>
