					...
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-tr_abacus_kode">
								...
								<input readonly="readonly" type="text" id="TrAbacus-tr_abacus_kode" class="form-control" name="TrAbacus[tr_abacus_kode]" autocomplete="off" value="">
								<input readonly="readonly" type="hidden" id="TrAbacus-tr_abacus_id" class="form-control" name="TrAbacus[tr_abacus_id]" autocomplete="off" value="">
								<input readonly="readonly" type="hidden" id="TrAbacus-tr_abacus_tgl_update" class="form-control" name="TrAbacus[tr_abacus_tgl_update]" autocomplete="off" value="">
								<input readonly="readonly" type="hidden" id="TrAbacus-tr_abacus_who_update" class="form-control" name="TrAbacus[tr_abacus_who_update]" autocomplete="off" value="">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-client_wms_id">
								...
								<select id="TrAbacus-client_wms_id" class="form-control select2" name="TrAbacus[client_wms_id]">
						...
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-tr_abacus_kode">
								...
								<input type="date" id="TrAbacus-tr_abacus_tanggal" class="form-control" name="TrAbacus[tr_abacus_tanggal]" autocomplete="off" value="<?= date('Y-m-d') ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-tr_abacus_reff_kode">
								...
								<input type="text" id="TrAbacus-tr_abacus_reff_kode" class="form-control" name="TrAbacus[tr_abacus_reff_kode]" autocomplete="off" value="">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-tr_abacus_keterangan">
								...
								<input type="text" id="TrAbacus-tr_abacus_keterangan" class="form-control" name="TrAbacus[tr_abacus_keterangan]" autocomplete="off" value="">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-tr_abacus_status">
								...
								<input readonly="readonly" type="text" id="TrAbacus-tr_abacus_status" class="form-control" name="TrAbacus[tr_abacus_status]" autocomplete="off" value="Draft" disabled>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group field-TrAbacus-tr_abacus_grand_total">
								...
								<input readonly="readonly" type="text" id="TrAbacus-tr_abacus_grand_total" class="form-control text-right mask-money" name="TrAbacus[tr_abacus_grand_total]" autocomplete="off" value="" disabled>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="x_panel">
					<div class="x_title">
						...
						<div class="pull-right">
							<button class="btn btn-primary" id="btn_refresh_abacus_detail" onclick="GetJumlahBayarDO()"><i class="fa fa-refresh"></i> <label name="CAPTION-REFRESH">Refresh</label></button>
						</div>
						<div class="clearfix"></div>
					</div>
