				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								...
								<input type="hidden" id="tgl_update_before" name="tgl_update_before" value="<?= $tgl_update_before->tgl_update ?>" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<select id="mutasi_draft_tipe_transaksi" name="mutasi_draft_tipe_transaksi" class="form-control select2" style="width:100%" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> required>
						...
						<div class="form-group">
							<label class="col-form-label col-md-4 col-sm-4 label-align" name="CAPTION-GUDANGASAL">Gudang
								Asal</label>
							<div class="col-md-6 col-sm-6">
								<select id="gudang_asal_mutasi_draft" name="gudang_asal_mutasi_draft" class="form-control select2" style="width:100%" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> onchange="ViewPallet()" required>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<select id="gudang_tujuan_mutasi_draft" name="gudang_tujuan_mutasi_draft" class="form-control select2" style="width:100%" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> required>
									<option value="">** <label name="CAPTION-PILIHGUDANG">Pilih Gudang</label> **
									</option>
									<?php foreach ($GudangTujuan as $row) { ?>
					...
					<div class="col-lg-6">
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<select id="mutasi_draft_perusahaan" name="mutasi_draft_perusahaan" class="form-control select2" style="width:100%" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> onchange="GetPrinciple(this.value)" required>
									<option value="">** <label name="CAPTION-PILIHPERUSAHAAN">Pilih Perusahaan</label> **
									</option>
									<?php foreach ($getClientWms as $row) { ?>
										<option value="<?= $row->client_wms_id ?>" <?= $MutasiPallet->client_wms_id == $row->client_wms_id ? 'selected' : ''; ?>>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<select id="mutasi_draft_principle" name="mutasi_draft_principle" class="form-control select2" style="width:100%" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> onchange="GetCheckerPrinciple(this.value)" required>
									<option value="">** <label name="CAPTION-PILIHPRINCIPLE">Pilih Principle</label> **
									</option>
									<?php foreach ($Principle as $row) { ?>
										<option value="<?= $row->id; ?>" <?= $MutasiPallet->principle_id == $row->id ? 'selected' : ''; ?>>
											<?= $row->nama; ?></option>
									<?php } ?>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<select id="mutasi_draft_checker" class="form-control select2" style="width:100%" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> required>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<textarea class="form-control" id="mutasi_draft_keterangan" name="mutasi_draft_keterangan" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?> required><?= $MutasiPallet->tr_mutasi_pallet_draft_keterangan ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<input type="checkbox" name="mutasi_draft_approval" id="mutasi_draft_approval" value="In Progress Approval" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'checked' : ''; ?> <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'disabled' : ''; ?>>
								<label name="CAPTION-PENGAJUANAPPROVAL">Pengajuan Approval</label>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="panel panel-default">
			<div class="panel-body form-horizontal form-label-left">
				<div class="row" style="margin-bottom: 10px;">
					<button class="btn btn-primary" id="btn_pilih_pallet_mutasi_draft" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'style="display: none;"' : ''; ?>><i class="fa fa-plus"></i> <label name="CAPTION-PILIHPALLET">Pilih Pallet</label></button>
				</div>
				<div class="row">
					<input type="hidden" id="txt_jml_pallet" value="<?= $MutasiPalletDetail != null ? count($MutasiPalletDetail) : 0; ?>">
					<input type="hidden" id="txt_index_pallet" value="<?= $MutasiPalletDetail != null ? count($MutasiPalletDetail) : 0; ?>">
				...
				<div class="row">
					...
					<button class="btn btn-success" id="btn_update_mutasi_draft" <?= $MutasiPallet->tr_mutasi_pallet_draft_status != "Draft" ? 'style="display: none;"' : ''; ?>><i class="fa fa-save"></i> <label name="CAPTION-SIMPAN">Simpan</label></button>
