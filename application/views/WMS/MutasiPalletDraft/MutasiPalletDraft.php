    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-PENCARIANDRAFTMUTASIPALLET">Pencarian Draft Mutasi Pallet</h3>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select id="filter_gudang_tujuan_mutasi_draft" name="filter_gudang_tujuan_mutasi_draft" class="form-control select2" style="width:100%">
                                    <option value=""><label name="CAPTION-ALL">All</label></option>
                                    <?php foreach ($Gudang as $row) { ?>
                                        <option value="<?= $row['depo_detail_id']; ?>"><?= $row['depo_detail_nama']; ?>
                                        </option>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select id="filter_mutasi_draft_tipe_transaksi" name="filter_mutasi_draft_tipe_transaksi" class="form-control select2" style="width:100%">
                                    <option value=""><label name="CAPTION-ALL">All</label></option>
        ...
        <div class="panel panel-default">
            <div class="panel-body form-horizontal form-label-left">
                <div class="row" style="margin-bottom:10px;">
                    <a href="<?= base_url(); ?>WMS/MutasiPalletDraft/MutasiPalletDraftForm" class="btn btn-primary"><i class="fa fa-plus"></i> <label name="CAPTION-TAMBAHMUTASIPALLET">Tambah Mutasi
                            Pallet</label></a>
                </div>
                <div class="row">

                    <table id="table_pencarian_mutasi_draft" width="100%" class="table table-striped">
                        <thead>
