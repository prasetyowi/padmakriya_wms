    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-128001100">Permintaan Pembongkaran By Qty DO</h3>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <!-- <button class="btn-submit btn btn-success" id="btn_refresh"><i class="fa fa-refresh"></i> <span name="CAPTION-REFRESH">Refresh</span></button> -->
                                <button class="btn-submit btn btn-primary" id="btn-pembongkaran-barang" onclick="RequestPembongkaran()"><i class="fa fa-box"></i> <span name="CAPTION-LISTSKUYANAKANDIBONGKAR">List Sku Yang Akan Dibongkar </span><span id="spanCount">(0)</span></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
                ...
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-4">
                                        ...
                                        <select id="filter-modal-pembongkaran-principle" name="filter_principle" class="form-control select2" style="width: 100%;">
                                            <option value=""><label name="CAPTION-SEMUA">Semua</label></option>
                                            <?php foreach ($Principle as $row) : ?>
                                                <option value="<?= $row['principle_kode'] ?>"><?= $row['principle_kode'] ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-xs-4">
                                        ...
                                        <select id="filter-modal-pembongkaran-flag" name="filter_flag" class="form-control">
                                            <option value=""><label name="CAPTION-SEMUA">Semua</label></option>
                                            <option value="Bonus"><label name="CAPTION-BONUS">Bonus</label></option>
                                            <option value="Reguler"><label name="CAPTION-REGULER">Reguler</label></option>
                                        </select>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <span id="loadingview" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <span name="CAPTION-LOADING">Loading</span>...</span>
                                        <button type="button" id="btn-search-data-pembongkaran" class="btn btn-primary"><i class="fa fa-search"></i> <span name="CAPTION-CARI">Cari</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="x_panel">
                            ...
                            <h5 class="pull-left"><span style="background-color: yellow;"><strong>
                                        [*]</strong></span><strong> Sku Tidak Dapat Dibongkar</strong></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button style="display: none;" class="btn-submit btn btn-primary" id="btn-ajukan"><i class="fa fa-save"></i> <span name="CAPTION-REQUESTPEMBONGKARAN">Request
                        Pembongkaran</span></button>
                <button class="btn-submit btn btn-success" id="btn-hitung"><i class="fa fa-calculator"></i> <span name="CAPTION-HITUNG">Hitung</span></button>
                <button type="button" data-dismiss="modal" class="btn btn-danger"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="modal-pembongkaran-hasilsku" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title"><label name="CAPTION-HASILHITUNG">Hasil Hitung</label></h4>
            </div>
            <div class="modal-body">
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <h4 class="pull-left" name="CAPTION-SKUYGDIPILIH">SKU Yang Dipilih</h4>
                            <table class="table table-bordered" id="table-pembongkaran-hasilsku">
                                <thead>
                                    <tr>
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">No</th>
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">Sku</th>
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">Principle
                                        </th>
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">Brand</th>
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">Satuan Order
                                        </th>
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">Qty Order
                                        </th>
                                        <th colspan="8" class="text-center" style="vertical-align: middle;">Informasi
                                            Composite SKU Satuan</th>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="vertical-align: middle;">Area</th>
                                        <th class="text-center" style="vertical-align: middle;">Qty Tersedia</th>
                                        <th class="text-center" style="vertical-align: middle;">Satuan Tersedia</th>
                                        <th class="text-center" style="vertical-align: middle;">Exp Tersedia</th>
                                        <th class="text-center" style="vertical-align: middle;">QTY Order Rencana
                                            Bongkar</th>
                                        <th class="text-center" style="vertical-align: middle;">Keterangan</th>
                                        <th class="text-center" style="vertical-align: middle;">Rencana Bongkar</th>
                                        <th class="text-center" style="vertical-align: middle;">Request Bongkar</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
            ...
            <div class="modal-footer">
                <!-- <button type="button" class="btn btn-info" id="btnsavekonversi"><i class="fa fa-save"></i> <span name="CAPTION-SAVE"></span></button> -->
                <button class="btn-submit btn btn-primary" id="btn-ajukan"><i class="fa fa-save"></i> <span name="CAPTION-REQUESTPEMBONGKARAN">Request Pembongkaran</span></button>
                <!-- <button class="btn-submit btn btn-success" id="btn-hitung"><i class="fa fa-calculator"></i> <span name="CAPTION-HITUNG">Hitung</span></button> -->
                <button type="button" class="btn btn-danger" id="btn-close"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
            </div>
        </div>
    </div>
</div>
