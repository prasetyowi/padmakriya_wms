				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" id="mutasi_kode" class="form-control" name="mutasi_kode" value="" readonly />
								<input type="hidden" id="mutasi_no" class="form-control" name="mutasi_no" value="" readonly />
						...
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control datepicker" name="mutasi_tanggal" id="mutasi_tanggal" value="<?= date('d/m/Y'); ?>" disabled>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<select id="mutasi_draft_no" name="mutasi_draft_no" class="form-control select2" style="width:100%" onchange="GetMutasiDraft(this.value)" required>
									<option value="">** <label name="CAPTION-PILIHNODRAFTMUTASI">Pilih No Draft
											Mutasi<label> **</option>
									<?php foreach ($MutasiPalletDraft as $row) { ?>
										<option value="<?= $row['tr_mutasi_pallet_draft_id']; ?>">
											<?= $row['tr_mutasi_pallet_draft_kode']; ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<select id="gudang_asal_mutasi" name="gudang_asal_mutasi" class="form-control" style="width:100%" readonly></select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<select id="gudang_tujuan_mutasi" name="gudang_tujuan_mutasi" class="form-control" style="width:100%" readonly></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-form-label col-lg-4 col-md-12 col-sm-12 col-xs-12 label-align" name="CAPTION-PERUSAHAAN">Perusahaan</label>
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control" name="mutasi_perusahaan" id="mutasi_perusahaan" value="" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-form-label col-lg-4 col-md-12 col-sm-12 col-xs-12 label-align" name="CAPTION-PRINCIPLE">Principle</label>
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control" name="mutasi_principle" id="mutasi_principle" value="" readonly>
							</div>
						</div>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control" name="mutasi_checker" id="mutasi_checker" value="" readonly>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control" name="mutasi_tipe_transaksi" id="mutasi_tipe_transaksi" value="" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-form-label col-lg-4 col-md-12 col-sm-12 col-xs-12 label-align" name="CAPTION-KETERANGAN">Keterangan</label>
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<textarea class="form-control" id="mutasi_keterangan" name="mutasi_keterangan" required></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-form-label col-lg-4 col-md-12 col-sm-12 col-xs-12 label-align" name="CAPTION-STATUS">Status</label>
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control" name="mutasi_status" id="mutasi_status" value="In Progress" readonly>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="panel panel-default">
			<div class="panel-body form-horizontal form-label-left">
				...
				<div class="row">
					...
					<button class="btn btn-primary" id="btn_konfirmasi_mutasi"><i class="fa fa-check"></i> <label name="CAPTION-KONFIRMASI">Konfirmasi</label></button>
					<button class="btn btn-success" id="btn_save_mutasi"><i class="fa fa-save"></i> <label name="CAPTION-SIMPAN">Simpan</label></button>
