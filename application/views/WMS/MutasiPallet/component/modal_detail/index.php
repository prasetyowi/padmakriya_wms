    ...
    <div class="modal-dialog" style="width:90%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- list data -->
                <?php $this->load->view("master/KonfirmasiDistribusiPenerimaan/component/modal_detail/list_data") ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-dark btn_close_detail"><i class="fas fa-xmark"></i> <label
