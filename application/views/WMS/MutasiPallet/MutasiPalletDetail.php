	...
	<div class="">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
									<textarea class="form-control" id="mutasi_keterangan" name="mutasi_keterangan" <?= ($header['tr_mutasi_pallet_status'] == 'Completed' || $header['tr_mutasi_pallet_status'] == 'canceled') ? 'readonly' : ''; ?>><?= $header['tr_mutasi_pallet_keterangan']; ?></textarea>
								</div>
							</div>
							<div class="form-group">
		...
		<div class="panel panel-default">
			<div class="panel-body form-horizontal form-label-left">
				...
				<?php if ($header['tr_mutasi_pallet_status'] != "Completed" && $header['tr_mutasi_pallet_status'] != "canceled") { ?>
				...
				<div class="row">
					...
					<button class="btn btn-primary" id="btn_konfirmasi_mutasi" <?= ($header['tr_mutasi_pallet_status'] == 'Completed' || $header['tr_mutasi_pallet_status'] == "canceled") ? 'style="display: none;"' : ''; ?>><i class="fa fa-check"></i> <label name="CAPTION-KONFIRMASI">Konfirmasi</label></button>
					<button class="btn btn-success" id="btn_update_mutasi" <?= ($header['tr_mutasi_pallet_status'] == 'Completed' || $header['tr_mutasi_pallet_status'] == "canceled") ? 'style="display: none;"' : ''; ?>><i class="fa fa-save"></i> <label name="CAPTION-SIMPAN">Simpan</label></button>
