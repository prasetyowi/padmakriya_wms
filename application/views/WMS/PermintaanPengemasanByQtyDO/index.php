    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-128001300">Permintaan Pengemasan By Qty DO</h3>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary" id="btn-pengemasan-barang" onclick="RequestPengemasan()"><i class="fa fa-box"></i> <span name="CAPTION-LISTSKUYANAKANDIKEMAS">List Sku Yang Akan Dikemas</span> <span id="spanCount">(0)</span></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modal-pengemasan-sku" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
                ...
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <span id="loadingview" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <span name="CAPTION-LOADING">Loading</span>...</span>
                                        <button type="button" id="btn-search-data-pengemasan" class="btn btn-primary"><i class="fa fa-search"></i> <span name="CAPTION-CARI">Cari</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="x_panel">
                            ...
                            <table class="table table-bordered" id="table-pengemasan-sku">
                                <thead>
                                    <tr class="bg-primary">
                                        <th><input type="checkbox" name="check-all-sku" id="check-all-sku"></th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-NO">No</th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUKODE">SKU Kode</th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKU">SKU</th>
                                        <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-AREA">AREA</th>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="btn-hitung"><i class="fa fa-calculator"></i> <span name="CAPTION-HITUNG">Hitung</span></button>
                <button type="button" data-dismiss="modal" class="btn btn-danger"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="modal-pengemasan-hasilsku" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
            ...
            <div class="modal-body">
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <h4 class="pull-left" name="CAPTION-SKUYGDIPILIH">SKU Yang Dipilih</h4>
                            <table class="table table-bordered" id="table-pengemasan-hasilsku">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">SKU Kode</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" style="vertical-align: middle;">QTY Order Rencana Bongkar</th>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="btn-ajukan-pengemasan"><i class="fa fa-save"></i> <span name="CAPTION-REQUESTPENGEMASAN">Request Pengemasan</span></button>
