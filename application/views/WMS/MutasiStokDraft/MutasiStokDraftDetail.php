                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="text" class="form-control datepicker" name="mutasi_draft_tanggal" id="mutasi_draft_tanggal" value="<?= $Header->tr_mutasi_stok_tanggal ?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align" name="CAPTION-PERUSAHAAN">Perusahaan</label>
                            <div class="col-md-6 col-sm-6">
                                <select id="mutasi_draft_perusahaan" name="mutasi_draft_perusahaan" class="form-control select2" style="width:100%" onchange="GetPrinciple(this.value)" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select id="mutasi_draft_principle" name="mutasi_draft_principle" class="form-control select2" style="width:100%" onchange="GetCheckerPrinciple(this.value)" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select id="gudang_asal_mutasi_draft" name="gudang_asal_mutasi_draft" class="form-control select2" style="width:100%" onchange="ViewPallet()" disabled>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select id="mutasi_draft_checker" name="mutasi_draft_checker" class="form-control select2" style="width:100%" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea class="form-control" id="mutasi_draft_keterangan" name="mutasi_draft_keterangan" disabled><?= $Header->tr_mutasi_stok_keterangan; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align" name="CAPTION-STATUS">Status</label>
                            <div class="col-md-6 col-sm-6">
                                <input type="text" name="mutasi_draft_status" id="mutasi_draft_status" class="form-control" value="<?= $Header->tr_mutasi_stok_status ?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align"></label>
                            <div class="col-md-6 col-sm-6">
                                <input type="checkbox" name="mutasi_draft_approval" style="transform: scale(1.5);" id="mutasi_draft_approval" value="In Progress Approval" <?= $Header->tr_mutasi_stok_status != 'Draft' ? 'checked' : '' ?> disabled> &nbsp;<label name="CAPTION-PENGAJUANAPPROVAL"> Pengajuan Approval</label>
                            </div>
                        </div>
                    </div>
                </div>
