    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 id="titleMenu" name="CAPTION-DETAILTINDAKLANJUTHASILSTOCKOPNAME">Detail Tindak Lanjut Hasil Stock Opname</h3>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php foreach ($detail as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $value['sku_qty_selisih'] ?></td>
                                            <td class="text-center"><?= $value['qty_invoice'] ?></td>
                                            <td class="text-center"><?= $value['qty_pemutihan'] ?></td>
                                            <td class="text-center"><?= $value['qty_opname_ulang'] ?></td>
                                        </tr>
                                    <?php endforeach  ?>
                                </tbody>
                            </table>
