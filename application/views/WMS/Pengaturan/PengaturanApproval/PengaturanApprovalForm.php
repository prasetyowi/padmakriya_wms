								...
								<thead>
									<tr>
										<th style="text-align: center;" name="CAPTION-DIRECTSUPERVISOR">Direct
											Supervisor</th>
										<th style="text-align: center;" name="CAPTION-NAMAGROUP">Nama Group</th>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel" style="display: flex;align-items:center;justify-content:space-between">
					...
					<div class="text-right">
						...
						<a class="btn btn-danger" href="<?php echo site_url('WMS/Pengaturan/PengaturanApproval/PengaturanApprovalMenu') ?>" name="CAPTION-KEMBALI">Kembali</a>
					</div>
				</div>
			</div>
		</div>
