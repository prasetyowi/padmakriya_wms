<div class="right_col" role="main">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <select id="filter_fdjr_driver" class="form-control select2" style="width:100%">
                                <option value="">** <span name="CAPTION-SALES">Sales</span> **</option>
    ...
    <div class="panel panel-default">
        <div class="panel-body form-horizontal form-label-left">
                        ...
                        <table id="tablefdjrmenu" width="100%" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th name="CAPTION-SALES" class="text-center">Sales</th>
                                    ...
                                    <th name="CAPTION-STATUSSETTLEMENTBARANG" class="text-center">Status Settlement
                                        Barang
                                    </th>
                                    <th name="CAPTION-STATUSSETTLEMENTTUNAI" class="text-center">Status Settlement Tunai
                                    </th>
                                    <th name="CAPTION-STATUSSETTLEMENT" class="text-center">Status Settelement</th>
            ...
            <!-- </div> -->
            <!-- <div class="row">
                <a href="<?php echo base_url(); ?>" class="btn btn-primary"><i class="fa fa-home"></i> <span
                        name="CAPTION-MENUUTAMA">Menu Utama</span></a>
            </div> -->
        </div>
    </div>
</div>
