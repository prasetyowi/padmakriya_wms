	...
	<div class="modal-dialog" style="width:90%">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<!-- filter data -->
				<?php $this->load->view("WMS/Transaksi/MutasiAntarUnit/PengambilanBarangMutasiAntarUnit/component/modal_pilih_pallet_view/filter_data") ?>

				<!-- list data -->
				<?php $this->load->view("WMS/Transaksi/MutasiAntarUnit/PengambilanBarangMutasiAntarUnit/component/modal_pilih_pallet_view/list_data") ?>
			</div>
