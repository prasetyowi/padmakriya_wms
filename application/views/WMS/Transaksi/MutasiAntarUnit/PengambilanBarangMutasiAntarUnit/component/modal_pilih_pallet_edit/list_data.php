				...
				<div class="col-xl-5 col-lg-5 col-md-5 col-xs-12">
					...
					<div id="preview_input_manual_edit" style="display: none;margin-top:10px">
						<div class="row">
							...
							<div class="col-md-6">
								<button type="button" class="btn btn-success" style="display: none;" id="check_kode_edit"><i class="fas fa-search"></i> <label name="CAPTION-CHECKKODE">Check Kode</label></button>
								<button type="button" class="btn btn-success" id="search_kode_pallet_edit"><i class="fas fa-search"></i> <label name="CAPTION-CHECKKODE">Check Kode</label></button>
						...
						<div class="form-group" style="display: none;">
							...
							<input id="myFileInput_edit" type="file" class="form-control" accept="image/*;capture=camera" onchange="previewFile_edit()">
						</div>
					...
					<table id="table_list_data_pilih_pallet_edit" width="100%" class="table table-striped">
						<thead>
							<tr class="text-center">
								<td><strong></strong></td>
								<td><strong><label name="CAPTION-LOKASIRAK">Lokasi Rak</strong></td>
								<td><strong><label name="CAPTION-LOKASIBIN">Lokasi Bin</strong></td>
								<td><strong><label name="CAPTION-NOPALLET">No. Pallet</strong></td>
								<td><strong><label name="CAPTION-EXPIREDDATE">Expired Date</strong></td>
								<td><strong><label name="CAPTION-QTY">Qty</strong></td>
								<!-- <td><strong><label name="CAPTION-QTYPLANKOREKSI">Qty Plan Koreksi</strong></td> -->
								<td><strong><label name="CAPTION-QTYAKTUALKOREKSI">Qty Aktual Koreksi</strong></td>
								<td><strong><label>Status</label></strong></td>
								<td><strong><label name="CAPTION-ACTION">Action</strong></td>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
