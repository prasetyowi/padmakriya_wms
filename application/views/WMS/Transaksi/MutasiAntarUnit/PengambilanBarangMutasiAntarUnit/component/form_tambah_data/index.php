	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>Menu Tambah Pengambilan Barang Mutasi Antar Unit</h3>
			</div>
		...
		<!-- filter data tambah -->
		<?php $this->load->view("WMS/Transaksi/MutasiAntarUnit/PengambilanBarangMutasiAntarUnit/component/form_tambah_data/filter") ?>

		<!-- list data tambah -->
		<?php $this->load->view("WMS/Transaksi/MutasiAntarUnit/PengambilanBarangMutasiAntarUnit/component/form_tambah_data/list_filter") ?>

		<!-- modal pilih pallet -->
		<?php $this->load->view("WMS/Transaksi/MutasiAntarUnit/PengambilanBarangMutasiAntarUnit/component/modal_pilih_pallet/index") ?>
