...
<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<h3 name="CAPTION-KOMPARASISTOKFISIKDANSISTEM">Komparasi Stok Fisik Dan Sistem</h3>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body form-horizontal form-label-left">
				...
				<div class="col-xs-12 text-right">
					...
					<button type="button" id="btncariAll" class="btn btn-primary" onclick="Get_komparasi_stok_fisik_dan_sistem()"><i class="fa fa-search"></i> <label name="CAPTION-CARI">Cari</label></button>
				</div>
			</div>
		</div>
		<div class="panel panel-default">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="x_content table-responsive">
							<table id="table_report_komparasi_stok_fisik_dan_sistem" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										...
										<th class="text-center" name="CAPTION-SKUQTYAKTUAL">SKU Qty Aktual</th>
										<th class="text-center" name="CAPTION-SKUQTYSISTEM">SKU Qty Sistem</th>
										<th class="text-center" name="CAPTION-SELISIH">Selisih</th>
									</tr>
								</thead>
								<tbody>
	...
	<div class="modal fade" id="modal_komparasi_stok_fisik_dan_sistem_detail" role="dialog" data-keyboard="false" data-backdrop="static">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 table-responsive">
							<table id="table_report_komparasi_stok_fisik_dan_sistem_detail" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										...
										<th class="text-center" name="CAPTION-TANGGALMULAI">Tanggal Mulai</th>
										<th class="text-center" name="CAPTION-TANGGALAKHIR">Tanggal Akhir</th>
										<th class="text-center" name="CAPTION-KARYAWAN">Karyawan</th>
										<th class="text-center" name="CAPTION-TIPESTOK">Tipe Stok</th>
										<th class="text-center" name="CAPTION-TIPEOPNAME">Tipe Opname</th>
