...
<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<h3 name="CAPTION-ANALISISJUMLAHPENERIMAAN">Analisis Jumlah Penerimaan</h3>
		</div>
			...
			<div class="panel-body form-horizontal form-label-left">
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group" id="span_tahun">
						...
						<div class="form-group" id="span_tanggal" style="display: none;">
		...
		<div class="panel panel-default">
			<div class=" panel-body form-horizontal form-label-left">
				<div class="row">
					<div class="col-xs-12">
						<h4 name="CAPTION-CHARTPENERIMAANBARANGSATUANCTN">Chart Penerimaan Barang (Satuan CTN)</h4><br>
						<canvas id="chart_report_analisis_jumlah_penerimaan" width="400" height="200"></canvas>
					</div>
				</div>
			</div>
		</div>
		<div class="panel panel-default">
			<div class=" panel-body form-horizontal form-label-left">
				<div class="row">
					<div class="col-xs-12">
						<h4 name="CAPTION-TABELPENERIMAANBARANGSATUANCTN">Tabel Penerimaan Barang (Satuan CTN)</h4>
						<div class="x_content table-responsive">
							<table id="table_report_analisis_jumlah_penerimaan" width="100%" class="table table-bordered text-center">
								<thead>
	...
	<div class="modal fade" id="modal_detail_analisis_jumlah_penerimaan" role="dialog" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-lg" style="width:95%;">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h4 class="modal-title inputTitle">Detail Analisis Jumlah Penerimaan</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 table-responsive" id="span_detail_tahun" style="display: none;">
							<table id="table_report_analisis_jumlah_penerimaan_detail_tahun" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										...
										<th class="text-center" name="CAPTION-PERUSAHAAN">Perusahaan</th>
										<th class="text-center" name="CAPTION-PRINCIPLE">Principle</th>
										<th class="text-center" name="CAPTION-DITOLAK">Ditolak</th>
										<th class="text-center" name="CAPTION-PECAH">Pecah</th>
										<th class="text-center" name="CAPTION-KLAIM">Klaim</th>
										<th class="text-center" name="CAPTION-RETUR">Retur</th>
										<th class="text-center" name="CAPTION-LAINLAIN">Lain-Lain</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
						...
						<div class="col-xs-12 table-responsive" id="span_detail_bulan" style="display: none;">
							<table id="table_report_analisis_jumlah_penerimaan_detail_bulan" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										<th class="text-center" name="CAPTION-TAHUN">Tahun</th>
						...
						<div class="col-xs-12 table-responsive" id="span_detail_tanggal" style="display: none;">
							<table id="table_report_analisis_jumlah_penerimaan_detail_tanggal" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
	...
	<div class="modal fade" id="modal_detail_analisis_jumlah_penerimaan_by_tipe" role="dialog" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-lg" style="width:95%;">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h4 class="modal-title inputTitle">Detail Analisis Jumlah Penerimaan</h4>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 table-responsive">
							<table id="table_report_analisis_jumlah_penerimaan_detail_by_tipe" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										<th class="text-center">No</th>
										<th class="text-center" name="CAPTION-PERUSAHAAN">Perusahaan</th>
										<th class="text-center" name="CAPTION-KODE">Kode</th>
										<th class="text-center" name="CAPTION-NOSJ">No SJ</th>
										<th class="text-center" name="CAPTION-TANGGAL">Tanggal</th>
										<th class="text-center" name="CAPTION-NOPOL">Nopol</th>
										<th class="text-center" name="CAPTION-PRINCIPLE">Principle</th>
										<th class="text-center" name="CAPTION-SKUKONVERSIGROUP">SKU Konversi Group</th>
										<th class="text-center" name="CAPTION-SKU">SKU</th>
										<th class="text-center" name="CAPTION-SKUSATUAN">SKU Satuan</th>
										<th class="text-center" name="CAPTION-EXPDATE">Exp Date</th>
										<th class="text-center" name="CAPTION-JUMLAHBARANGTERIMA">Jumlah Barang Terima</th>
		...
		<div class="modal-dialog modal-lg" style="width:95%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 table-responsive">
							<table id="table_stock_detail" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										<th class="text-center" name="CAPTION-TANGGAL">Tanggal</th>
