...
<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<h3 name="CAPTION-ANALISISJUMLAHPENERIMAAN">Analisis Performa Bongkar Muat</h3>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body form-horizontal form-label-left">
				...
				<div class="col-xs-12 text-right">
					...
					<button type="button" id="btncariAll" class="btn btn-primary" onclick="Get_analisis_performa_bongkar_muat()"><i class="fa fa-search"></i> <label name="CAPTION-CARI">Cari</label></button>
				</div>
			</div>
		</div>
		<div class="panel panel-default">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="x_content table-responsive">
							<table id="table_report_analisis_performa_bongkar_muat" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										...
										<th class="text-center" name="CAPTION-JUMLAHBARANGTERIMA">Jumlah Barang Terima (CTN)</th>
										<th class="text-center"><span name="CAPTION-WAKTUPENGERJAAN">Waktu Pengerjaan</span> (<span name="CAPTION-JAM">Jam</span>)</th>
										<th class="text-center"><span name="CAPTION-PEFORMA">Peforma</span> (%)</th>
									</tr>
								</thead>
								<tbody>
	...
	<div class="modal fade" id="modal_analisis_performa_bongkar_muat_detail" role="dialog" data-keyboard="false" data-backdrop="static">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 table-responsive">
							<table id="table_report_analisis_performa_bongkar_muat_detail" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
