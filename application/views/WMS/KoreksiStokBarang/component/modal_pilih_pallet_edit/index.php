  ...
  <div class="modal-dialog" style="width:90%">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- filter data -->
        <?php $this->load->view("WMS/KoreksiStokBarang/component/modal_pilih_pallet_edit/filter_data") ?>

        <!-- list data -->
        <?php $this->load->view("WMS/KoreksiStokBarang/component/modal_pilih_pallet_edit/list_data") ?>
      </div>
