  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Menu Edit Koreksi Stok Barang</h3>
      </div>
    ...
    <!-- filter data edit -->
    <?php $this->load->view("WMS/KoreksiStokBarang/component/form_edit_data/filter") ?>

    <!-- list data edit -->
    <?php $this->load->view("WMS/KoreksiStokBarang/component/form_edit_data/list_filter") ?>

    <!-- modal pilih pallet -->
    <?php $this->load->view("WMS/KoreksiStokBarang/component/modal_pilih_pallet_edit/index") ?>
