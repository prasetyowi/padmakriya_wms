...
<div class="modal fade" id="modalUbahDriverKendaraan" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" style="width: 80%;">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<h4 class="modal-title"><label name="CAPTION-UBAHDRIVERKENDARAAN">Ubah Driver Kendaraan</label></h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<input type="hidden" id="delivery_order_batch_h_id" value="">
					<input type="hidden" id="do_batch_id" value="">
					<input type="hidden" id="last_update" value="">
					<input type="hidden" id="ubah_driver" value="">
					<input type="hidden" id="ubah_kendaraan" value="">
					<input type="hidden" id="mode" value="">
					<div class="col-xs-3">
						<label name="CAPTION-TANGGALPENGIRIMAN">Tanggal Pengiriman</label>
						<input type="date" id="ubahDriverKendaraanTanggal" class="form-control" name="ubahDriverKendaraanTanggal" value="<?= date("Y-m-d") ?>" />
					</div>
					<div class="col-xs-3">
						<label name="CAPTION-KENDARAAN">Kendaraan</label>
						<select name="ubahDriverKendaraanKendaraan" class="form-control select2" id="ubahDriverKendaraanKendaraan">
							<option value="">**<label name="CAPTION-PILIH">Pilih</label>**</option>
							<?php foreach ($Kendaraan as $row) : ?>
								<option value="<?= $row['kendaraan_id'] ?>"><?= $row['kendaraan_nopol'] ?> -
									<?= $row['kendaraan_model'] ?></option>
					...
					<div class="col-xs-3">
						<label name="CAPTION-Driver">Driver</label>
						<select name="ubahDriverKendaraanDriver" class="form-control select2" id="ubahDriverKendaraanDriver">
							<option value="">**<label name="CAPTION-PILIH">Pilih</label>**</option>
							<?php foreach ($Driver as $row) : ?>
								<option value="<?= $row['karyawan_id'] ?>"><?= $row['karyawan_nama'] ?></option>
							<?php endforeach; ?>
					...
					<div class="col-xs-3">
						<label name="CAPTION-RITASI">Ritasi</label>
						<input type="text" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="ubahDriverKendaraanRitasi" name="ubahDriverKendaraanRitasi" value="" />
					</div>
				</div>
				<br>
				<div class="row">
					<button type="button" style="float:right; margin-right:10px" id="btn-search-data-ubah-driver-kendaraan" class="btn btn-success"><i class="fa fa-search"></i> <label name="CAPTION-CARI">Cari</label></button>
				</div>
				<br>
				<div class="row">
					<div class="table-responsive">
						<table class="table table-striped" id="table-ubah-driver-kendaraan">
							<thead>
								<tr class="bg-primary">
									<th class="text-center" style="color:white;" name="CAPTION-TANGGALPENGIRIMAN">Tanggal Pengiriman</th>
									<th class="text-center" style="color:white;" name="CAPTION-KENDARAAN">Kendaraan</th>
			...
			<div class="modal-footer">
				<button style="display:none;" class="btn-submit btn btn-success" id="btn_ubah_driver_kendaraan" onclick="saveUbahDriverKendaraan(null)"><span name="CAPTION-SIMPAN">Simpan</span></button>
				<button type="button" data-dismiss="modal" class="btn btn-danger"><label name="CAPTION-TUTUP">Tutup</label></button>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="modal_attachment_delivery_order" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" style="width: 80%;">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<h4 class="modal-title"><label name="CAPTION-ATTACHMENTPERIMTAANPENGIRIMAN">Attachment Permintaan Pengiriman</label></h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<input type="hidden" id="filter_attachment_delivery_order_batch_id" value="">
					<div class="col-xs-3">
						<label name="CAPTION-NOFDJR">Nomor FDJR</label>
						<input type="text" id="filter_attachment_delivery_order_batch_kode" class="form-control" name="filter_attachment_delivery_order_batch_kode" value="" disabled />
					</div>
					<div class="col-xs-3">
						<label name="CAPTION-TANGGALPENGIRIMAN">Tanggal Pengiriman</label>
						<input type="text" id="filter_attachment_tanggal_pengiriman" class="form-control" name="filter_attachment_tanggal_pengiriman" value="" disabled />
					</div>
					<div class="col-xs-3">
						<label name="CAPTION-PENGEMUDI">Pengemudi</label>
						<input type="text" id="filter_attachment_pengemudi" class="form-control" name="filter_attachment_pengemudi" value="" disabled />
					</div>
					<div class="col-xs-3">
						<label name="CAPTION-NOPOLKENDARAAN">Nopol Kendaraan</label>
						<input type="text" id="filter_attachment_nopol_kendaraan" class="form-control" name="filter_attachment_nopol_kendaraan" value="" disabled />
					</div>
				</div>
				<br>
				<div class="row">
					<div class="table-responsive">
						<table class="table table-striped" id="table-attachment-delivery-order">
							<thead>
								<tr class="bg-primary">
									<th class="text-center" style="color:white;">#</th>
									<th class="text-center" style="color:white;" name="CAPTION-NODO">No. DO</th>
									<th class="text-center" style="color:white;" name="CAPTION-ATTACHMENT">Attachment</th>
								</tr>
							</thead>
							<tbody>
