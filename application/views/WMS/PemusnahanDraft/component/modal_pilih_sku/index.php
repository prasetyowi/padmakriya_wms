  ...
  <div class="modal-dialog" style="width:90%">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- filter data -->
        <?php $this->load->view("WMS/PemusnahanDraft/component/modal_pilih_sku/filter_data") ?>

        <!-- list data -->
        <?php $this->load->view("WMS/PemusnahanDraft/component/modal_pilih_sku/list_data") ?>
      </div>
