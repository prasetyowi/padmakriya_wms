<div class="row" id="show-filter-list" style="display: none;">
      ...
      <div class="container mt-2">
        <div class="row" style="margin-top: 10px;">
          <div class="x_content table-responsive">
            <table id="list_data_filter" width="100%" class="table table-striped">
              <thead>
                <tr>
                  <th class="text-center">#</th>
                  <th class="text-center" name="CAPTION-NODRAFTBERITAACARA">No Draft Berita Acara</th>
        ...
        <div style="float: right">
          <a href="<?= base_url(); ?>" class="btn btn-primary" id="btn_kembali"><i class="fa fa-home"></i> Menu Utama</a>
        </div> -->
      </div>
    </div>
  </div>
