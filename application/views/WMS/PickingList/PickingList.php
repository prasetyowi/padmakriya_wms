    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-130005006">Permintaan Barang</h3>
            </div>
        </div>
                    ...
                    <div class="x_content">
                        <form id="form-filter-do" class="form-horizontal form-label-left">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" name="daterange" id="tgl"
                                            required="required">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="driver" id="driver" class="form-control select2">
                                            ...
                                            <option value="<?= $data['karyawan_id'] ?>"><?= $data['karyawan_nama'] ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label name="CAPTION-NOFDJR">No FDJR</label>
                                        <select name="fdjr" id="fdjr" class="form-control select2">
                                            <option value="">-- Pilih FDJR --</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="item form-group">
										<label class="col-form-label col-md-6 col-sm-6 label-align" name="CAPTION-TANGGALAKHIR">Tanggal Akhir
										</label>
										<div class="col-md-6 col-sm-6">
											<input type="date" class="form-control input-date-start" name="tgl2" id="tgl2" placeholder="dd-mm-yyyy" required="required" value="<?php echo Date('Y-m-d') ?>">
										</div>

									</div> -->
                            <!-- <div class="item form-group">
                                        <label class="col-form-label col-md-6 col-sm-6 label-align">No Permintaan Barang <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="no_picking">
                            ...
                            <!-- <div class="col-lg-6">
									<div class="item form-group">
										<label class="col-form-label col-md-6 col-sm-6 label-align" name="CAPTION-TIPEPERMINTAANBARANG">Tipe Permintaan Barang
										</label>
										<div class="col-md- col-sm-6">
									...
									<div class="item form-group">
										<label class="col-form-label col-md-6 col-sm-6 label-align" for="status">Status
									...
									<div class="item form-group">
										<label class="col-form-label col-md-6 col-sm-6 label-align" for="area" name="CAPTION-013001000">Area
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 text-left">
                                    <a class="btn btn-md btn-primary btn-submit-filter"
                                        onclick="getDataPickingListSearch()"><label name="CAPTION-CARI">Cari</label></a>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form id="form-assign-checker" class="form-horizontal form-label-left">
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Checker <span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6">
