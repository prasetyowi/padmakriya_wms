			...
			<div class="modal-dialog" style="width:90%">
				...
				<div class="modal-content">
					<div class="modal-header bg-primary">
						<h4 class="modal-title" name="CAPTION-DETAILFDJRBOSNET">Detail FDJR Bosnet: <strong id="title_sj"></strong></h4>
					</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="x_panel">
								<div class="container mt-2">
									<div class="row">
										<div class="x_content table-responsive">
											<table id="table_detail_fdjr_bosnet" width="100%" class="table table-striped">
												<thead>
													<tr style="background:#F0EBE3;">
														<th style="vertical-align: middle;text-align:center;" name="CAPTION-IDPENGEMUDI">ID PENGEMUDI</th>
														<th style="vertical-align: middle;text-align:center;" name="CAPTION-TANGGALPENGIRIMAN">TANGGAL PENGIRIMAN</th>
