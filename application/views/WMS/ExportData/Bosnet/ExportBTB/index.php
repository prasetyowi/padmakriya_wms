...
<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<h3 name="CAPTION-EXPORTBTB">Export Bukti Terima Barang</h3>
		</div>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-xs-4">
							...
							<select class="form-control select2" id="filter_driver" name="filter_driver[]" multiple data-placeholder="Click to choose">
								<option value=""><label name="CAPTION-PILIH">Pilih</label></option>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="x_content table-responsive">
							<table id="table_export_penerimaan_penjualan" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-SOBOSNET">SO Bosnet</th>
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-DELIVERYORDERKODE">Delivery Order Kode</th>
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-SKUGROUP">SKU Group</th>
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-SKU">SKU</th>
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-QTYTERIMA">Qty Terima</th>
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-GUDANG">Gudang</th>
										<th style="vertical-align: middle;text-align:center;" name="CAPTION-TIPEPERSEDIAAN">Tipe Persediaan</th>
									</tr>
								</thead>
								<tbody>
