						...
						$.each(response, function(i, v) {
							...
							$("#table_export_penerimaan_surat_jalan > tbody").append(`
								<tr>
									...
									<td style="vertical-align: middle;text-align:center;"><button class="btn btn-primary" onclick="getDetail('${v.penerimaan_surat_jalan_id}', '${v.penerimaan_surat_jalan_no_sj}','${v.principle_id}', '${v.principle_kode}', '${v.penerimaan_surat_jalan_tgl}')"><i class="fa fa-eye"></i></button></td>
								</tr>
							`);
						});
