    ...
    <div class="">
        ...
        <div class="row" id="panel-sku">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div style="float: right">
                    <a href="<?= base_url() ?>WMS/SettlementPengiriman/SettlementMenu/?delivery_order_batch_id=<?= $delivery_order_batch_id ?>" class="btn btn-info"><i class="fa fa-reply"></i> <label name="CAPTION-KEMBALI">Kembali</label></a>
