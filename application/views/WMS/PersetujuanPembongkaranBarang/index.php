    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-PERSETUJUANPEMBONGKARAN">Persetujuan Pembongkaran</h3>
            </div>
            <div style="float: right">
                <?php if ($Menu_Access["C"] == 1) : ?>
                    <a href="<?= base_url('WMS/PersetujuanPembongkaranBarang/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <label name="CAPTION-BARU">Baru</label></a>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <input type="text" id="filter-konversi-date" class="form-control" name="filter_konversi_date" value="" />
                            </div>
                            <div class="col-xs-4">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <span id="loadingviewkonversi" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <label name="CAPTION-LOADING">Loading</label>...</span>
                                <button type="button" id="btn-search-data-konversi" class="btn btn-success"><i class="fa fa-search"></i> <span name="CAPTION-CARI">Cari</span></button>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="x_content table-responsive">
                                <table id="table_list_data_konversi" width="100%" class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="bg-primary">
                                            <td class="text-center" style="color:white;"><strong><label name="CAPTION-TANGGAL">Tanggal</label></strong></td>
                                            <td class="text-center" style="color:white;"><strong><label name="CAPTION-NOPERSETUJUANPEMBONGKARAN">No. Persetujuan
                                                        Pembongkaran</label></strong></td>
                                            <td class="text-center" style="color:white;"><strong><label name="CAPTION-PERUSAHAAN">Perusahaan</label></strong></td>
