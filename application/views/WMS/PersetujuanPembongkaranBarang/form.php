            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group field-persetujuanpembongkaran-tr_konversi_sku_tanggal">
                                ...
                                <input type="text" id="persetujuanpembongkaran-tr_konversi_sku_tanggal" class="form-control datepicker" name="persetujuanpembongkaran[tr_konversi_sku_tanggal]" autocomplete="off" value="<?= date('d-m-Y') ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-persetujuanpembongkaran-tr_konversi_sku_kode">
                                ...
                                <select name="persetujuanpembongkaran[tipe_konversi_id]" class="form-control" id="persetujuanpembongkaran-tipe_konversi_id">
                                    <option value="">** <label name="CAPTION-TIPE">Tipe</label> **</option>
                                    <?php foreach ($TipeKonversi as $type) : ?>
                                        <option value="<?= $type['tipe_konversi_id'] ?>"><?= $type['tipe_konversi_nama'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-xs-6">
                            <div class="form-group field-persetujuanpembongkaran-principle_id">
                                <label for="persetujuanpembongkaran-principle_id" class="control-label" name="CAPTION-PRINCIPLE">Principle</label>
                                <select id="persetujuanpembongkaran-principle_id" class="form-control select2" name="persetujuanpembongkaran[principle_id]">
                        ...
                        <div class="col-xs-6">
                            ...
                            <!-- <div class="form-group field-persetujuanpembongkaran-depo_detail_id">
                                <label for="persetujuanpembongkaran-gudang-tujuan" class="control-label" name="CAPTION-LOKASITUJUAN">Lokasi Tujuan</label>
                                <select id="persetujuanpembongkaran-gudang-tujuan" class="form-control select2" name="persetujuanpembongkaran-gudangtujuan">
                            ...
                            <div class="form-group field-persetujuanpembongkaran-konversi_is_need_approval">
                                <input type="checkbox" id="persetujuanpembongkaran-konversi_is_need_approval" name="persetujuanpembongkaran[konversi_is_need_approval]" autocomplete="off" value="1"> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row" id="panel-sku">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div style="float: right">
                    ...
                    <button class="btn-submit btn btn-success" id="btnsavekonversi"><i class="fa fa-save"></i> <label name="CAPTION-SIMPAN">Simpan</label></button>
                </div>
            </div>
        </div>
    </div>
