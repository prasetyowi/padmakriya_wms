    ...
    <div class="container mt-2">
      <div class="row">
        <div class="x_content table-responsive">
          <table id="table_list_detail" width="100%" class="table table-striped">
            <thead>
              <tr>
                ...
                <td width="10%" class="text-center"><strong><label name="CAPTION-EXPIREDDATE">Exp Date</label></strong></td>
                <td width="10%" class="text-center"><strong><label name="CAPTION-TIPE">Tipe</label></strong></td>
                <td width="5%" class="text-center"><strong><label name="CAPTION-JUMLAHBARANG">Jumlah Barang</label></strong></td>
              </tr>
            </thead>
            <tbody></tbody>
          </table>
