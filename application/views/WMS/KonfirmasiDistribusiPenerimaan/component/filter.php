				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-xs-12">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="hidden" class="form-control" id="client_wms" />
									<input type="hidden" class="form-control" id="tr_mutasi_draft_id" />
									<input type="hidden" class="form-control" id="distribusi_id" />
									<input type="text" class="form-control" name="no_mutasi" id="no_mutasi" placeholder="Auto" required readonly>
						...
						<div class="form-group">
							...
							<select class="form-control select2" name="no_draft_mutasi" id="no_draft_mutasi" required disabled></select>
						</div>

						<div class="form-group">
							<label name="CAPTION-NOPENERIMAAN">No. Penerimaan</label>
							<input type="text" class="form-control" name="no_penerimaan" id="no_penerimaan" placeholder="No. Penerimaan" required readonly />
						</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-xs-12">
						<!-- <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_sj" id="no_sj" placeholder="No. Surat Jalan" required readonly />
                        </div> -->
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control select2" name="gudang_tujuan" id="gudang_tujuan" required disabled></select>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-5">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="checker" id="checker" placeholder="Checker" readonly required />
								</div>
							</div>
							<div class="col-md-7">
								<div class="form-group">
									<label name="CAPTION-TIPETRANSAKSI">Tipe Transaksi</label>
									<select class="form-control select2" name="tipe_transaksi" id="tipe_transaksi" required disabled></select>
								</div>
							</div>
						</div>
