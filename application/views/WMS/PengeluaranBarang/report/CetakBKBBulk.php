...
<body>
	...
	if ($cetak == 'perprinciple') {
		foreach ($bkbbulk as $key => $val) {
	?>
			<div class="lanscape <?= $key + 1 == count($bkbbulk) ? '' : 'break' ?>">
				<h3 class="text-center">Data BKB Bulk <?= $tipe == 'aktual' ? 'Aktual' : 'Plan' ?></h3>
				...
				<table class="table12" style="width:100%;padding-bottom: 10px;">
					<tr>
						...
						<td style="text-align: left; border: 0;"><?= $bkbbulkheader[0]->delivery_order_batch_kode; ?></td>
						<td style="width: 15rem; border: 0;"></td>
						<th style="text-align: left; border: 0;">Driver</th>
						<td style="text-align: left; border: 0;">:</td>
						<td style="text-align: left; border: 0;"><?= $bkbbulkheader[0]->driver_nama; ?></td>
					</tr>
					<tr>
						<th style="text-align: left; border: 0;">No PBB</th>
						<td style="text-align: left; border: 0;">:</td>
						<td style="text-align: left; border: 0;"><?= $bkbbulkheader[0]->picking_order_kode; ?></td>
						</td>
						<td style="width: 15rem; border: 0;"></td>
						<th style="text-align: left; border: 0;">Armada</th>
						<td style="text-align: left; border: 0;">:</td>
						<td style="text-align: left; border: 0;"><?= $bkbbulkheader[0]->kendaraan_nopol; ?></td>
					</tr>
					<tr>
						<th style="text-align: left; border: 0;">Tanggal Kirim</th>
						<td style="text-align: left; border: 0;">:</td>
						<td style="text-align: left; border: 0;"><?= $bkbbulkheader[0]->delivery_order_batch_tanggal_kirim; ?></td>
						<td style="width: 15rem; border: 0;"></td>
				...
				<div>
					<table class="table-content" width="100%" id="initDataCetakBKBBulk-<?= $key ?>">
						<thead>
		...
		<div class="lanscape">
			...
			<div>
				<table class="table-content" width="100%" id="initDataCetakBKBBulk">
					<thead>
						<tr class="text-center" style="background-color: #EEE0C9;">
							<th>Gudang</th>
							<th>Area</th>
	...
	<script>
		...
		$(document).ready(function() {
			<?php if ($cetak == 'perprinciple') : ?>
				var total = <?= COUNT($bkbbulk); ?>;

				for (let i = 0; i < total; i++) {
					MergeCommonRows($('#initDataCetakBKBBulk-' + i + ''));

				}
			<?php else : ?>
				MergeCommonRows($('#initDataCetakBKBBulk'));
			<?php endif; ?>
		...
		// console.log(MergeCommonRows($('#initDataCetakBKBBulk')));
	</script>