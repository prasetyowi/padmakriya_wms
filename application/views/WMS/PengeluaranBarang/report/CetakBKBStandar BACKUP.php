...
<head>
   <meta charset="utf-8" />
   <title><label name="CAPTION-FORMPERMINTAANPENGELUARANBARANGSTANDAR"></label></title>
...
<body style="font-family:'Courier New', Courier, monospace">
   <div class="lanscape">
      <header class="clearfix">
         <center>
            <h3 name="CAPTION-PERMINTAANPENGELUARANBARANGSTANDAR"></h3>
         </center>
         <br>
         <!-- status manifes do -->
         <table class="table12" id="list_emp" width="100%" style="font-size: 15px;">
            <tbody>
               <tr>
                  ...
                  <td width="50%"><?= $bkbstandar[0]['karyawan_nama'] ?></td>
                  <td width="30%" class="text-center" style="vertical-align: middle;" rowspan="3">
                     <?php
                     require 'vendor/autoload.php';

                     $generator = new Picqer\Barcode\BarcodeGeneratorPNG();
                     echo '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($bkbstandar[0]['picking_list_kode'], $generator::TYPE_CODE_128)) . '" style="width:200px;height:50px;">';
                     ?>
                     <!-- <img class="barcode" src="<?= base_url('assets/images/barcode.png'); ?>" style="width: 200px" /> -->
                     <p class="text-center"><?= $bkbstandar[0]['picking_list_kode'] ?></p>
                  </td>
                  </td>
               </tr>
               <tr>
                  <td width="20%" name="CAPTION-TGLPPB"></td>
                  <td width="50%"><?= $bkbstandar[0]['picking_order_tanggal'] ?></td>
               </tr>
               <tr>
                  <td width="20%" name="CAPTION-TGLPB"></td>
                  <td width="50%"><?= $bkbstandar[0]['picking_list_tgl_kirim'] ?></td>
               </tr>
               <tr>
                  <td width="20%">Principal</td>
                  <td width="50%"><?= $bkbstandar[0]['principal'] ?></td>
                  <td width="33%" class="text-center" style="vertical-align: middle;" rowspan="3">
                     <?php
                     require 'vendor/autoload.php';

                     $generator = new Picqer\Barcode\BarcodeGeneratorPNG();
                     echo '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($bkbstandar[0]['picking_order_kode'], $generator::TYPE_CODE_128)) . '" style="width:200px;height:50px;">';
                     ?>
                     <!-- <img class="barcode" src="<?= base_url('assets/images/barcode.png'); ?>" style="width: 200px"/> -->
                     <p class="text-center"><?= $bkbstandar[0]['picking_order_kode'] ?></p>
                  </td>
               </tr>
               <tr>
               ...
               <table class="gridtable" id="list_emp" width="100%" style="font-size: 15px;">
                  <thead>
                     <tr>
                        ...
                        <th class="text-center" name="CAPTION-JUMLAHBARANG"></th>
                  ...
                  <tbody>
                     ...
                     foreach ($bkbstandar as $row) {

                     ?>
                        <tr>
                           <td class="text-center"><?= $row['delivery_order_kode'] ?></td>
