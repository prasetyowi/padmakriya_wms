		...
		<div class="container mt-2">
					...
					<div class="head-switch-global">
						<div class="switch-holder">
							...
							<div class="switch-label-global">
								<button type="button" class="btn btn-info" id="start_scan"><i class="fas fa-qrcode"></i> <label name="CAPTION-STARTSCAN">Start Scan</button>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" autocomplete="off" id="kode_barcode" placeholder="nomor setelah tanda '/' terakhir">
							...
							<div class="col-md-6">
								...
								<span id="loading_cek_manual" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <label name="CAPTION-CHECKKODE">Loading</label>...</span>
							</div>
						</div>
			...
			<div class="row" style="margin-top: 12px;">
				<div class="x_content table-responsive">
					<table id="table_list_data_pilih_pallet" width="100%" class="table table-striped">
						<thead>
