  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 name="CAPTION-MENUEDITBERITAACARA">Menu Edit Berita Acara</label></h3>
      </div>
      <div style="float: right">
        <button type="button" class="btn btn-dark" id="kembali_koreksi_edit"><i class="fas fa-arrow-left"></i> <label name="CAPTION-BACK">Kembali</label></button>
      </div>
    </div>
    ...
    <!-- filter data edit -->
    <?php $this->load->view("WMS/Pemusnahan/component/form_edit_data/filter") ?>

    <!-- list data edit -->
    <?php $this->load->view("WMS/Pemusnahan/component/form_edit_data/list_filter") ?>

    <!-- modal pilih pallet -->
    <?php $this->load->view("WMS/Pemusnahan/component/modal_pilih_pallet_edit/index") ?>
