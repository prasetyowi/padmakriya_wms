  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 name="CAPTION-MENUTAMBAHBERITAACARA">Menu Tambah Berita Acara</h3>
      </div>
      <div style="float: right">
        <button type="button" class="btn btn-dark" id="kembali_koreksi"><i class="fas fa-arrow-left"></i> <label name="CAPTION-BACK">Kembali</label></button>
      </div>
    </div>
    ...
    <!-- filter data tambah -->
    <?php $this->load->view("WMS/Pemusnahan/component/form_tambah_data/filter") ?>

    <!-- list data tambah -->
    <?php $this->load->view("WMS/Pemusnahan/component/form_tambah_data/list_filter") ?>

    <!-- modal pilih pallet -->
    <?php $this->load->view("WMS/Pemusnahan/component/modal_pilih_pallet/index") ?>
