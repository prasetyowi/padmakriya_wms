        ...
        <?php foreach ($KonversiHeader as $i => $header) : ?>
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h4 class="pull-left" name="CAPTION-SCANPALLETTUJUAN">Scan Pallet Tujuan</h4>
                            <div class="clearfix"></div>
                        </div>
                            ...
                            <div class="row" style="margin-top:10px;margin-bottom:10px;margin-left:5px;margin-right:5px;">
                                    ...
                                    <div class="head-switch-global">
                                        <div class="switch-holder-global">
                                            ...
                                            <div class="switch-label-global">
                                                <button type="button" class="btn btn-info" id="start_scan"><i class="fas fa-qrcode"></i> <span name="CAPTION-STARTSCAN">Start Scan</span></button>
                                                <button type="button" class="btn btn-danger" style="display:none" id="stop_scan"><i class="fas fa-xmark"></i> <span name="CAPTION-STOPSCAN">Stop Scan</span></button>
                                                <button type="button" class="btn btn-warning" style="display:none" id="input_manual"><i class="fas fa-keyboard"></i> <span name="CAPTION-MANUALINPUT">Manual Input</span></button>
                                                <button type="button" class="btn btn-danger" style="display:none" id="close_input"><i class="fas fa-xmark"></i> <span name="CAPTION-CLOSEINPUT">Close Input</span></button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <span name="CAPTION-KODEPALLET">Kode Pallet</span>
                                                    <input type="text" class="form-control" id="kode_barcode" placeholder="PAL/00000001" value="<?= $pallet['pallet_kode'] ?>">
                                                    <input type="hidden" class="form-control" id="pallet_id_tujuan" value="<?= $pallet['pallet_id'] ?>">
                                                    <div style="max-height: 20vh;overflow:hidden;overflow-y:scroll">
                                                        <table class="table table-bordered table-sm table-hover" id="table-fixed">
                                            ...
                                            <div class="col-md-6">
                                                <div style="margin-top: 23px;">
                                                    <button type="button" class="btn btn-success" id="search_kode_pallet"><i class="fas fa-search"></i> <span name="CAPTION-CHECKKODE">Check Kode</span></button>
                                                    <button type="button" class="btn btn-success" id="check_kode" style="display: none;"><i class="fas fa-search"></i> <span name="CAPTION-CHECKKODE">Check Kode</span></button>
                                                    <span id="loading_cek_manual" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <span name="CAPTION-LOADING">Loading</span>...</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-xs-12">
                                    <div class="from-group">
                                        <span name="CAPTION-HASILSCANNOPALLET">Hasil Scan No. Pallet</span>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="table-responsive">
                        <button class="btn-submit btn btn-primary" id="btn_tambah_konversi_pengemasan"><i class="fa fa-plus"></i> <span name="CAPTION-TAMBAHKONVERSI">Tambah Konversi</span></button>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h4 class="pull-left" name="CAPTION-SKUKONVERSIGROUP">SKU Konversi Group</h4>
                        <div class="clearfix"></div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table-sku-konversi-group">
                            <thead>
                                <tr class="bg-primary">
                            ...
                            <tbody>
                                <?php foreach ($KonversiDetail as $i => $detail) : ?>
                                    <tr id="row-<?= $i ?>">
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            <?= $detail['sku_stock_qty_pallet_ambil'] ?>
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">
                ...
                <div style="float: right">
                    ...
                    <button class="btn-submit btn btn-primary" id="btn_konfirmasi_konversi"><i class="fa fa-check"></i> <label name="CAPTION-KONFIRMASI">Konfirmasi</label></button>
                    <button class="btn-submit btn btn-success" id="btn_update_konversi"><i class="fa fa-save"></i> <label name="CAPTION-SIMPAN">Simpan</label></button>
                    <button class="btn-submit btn btn-danger" id="btn_reject_konversi"><i class="fa fa-times"></i> <label name="CAPTION-BATALKAN">Batalkan</label></button>
    ...
    <div class="modal-dialog modal-lg" style="width:80%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button type="button" class="btn btn-primary" id="btn_tambah_pallet_asal"><i class="fa fa-plus"></i> <span name="CAPTION-TAMBAHPALLETASAL">Tambah Pallet Asal</span></button>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" id="btn_save_pallet_asal"><label name="CAPTION-SIMPAN">Simpan</label></button>
