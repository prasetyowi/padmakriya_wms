        ...
        <div class="page-title">
            ...
            <!-- <div style="float: right">
                <?php if ($Menu_Access["C"] == 1) : ?>
                    <a href="<?= base_url('WMS/KonversiPengemasanBarang/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <label name="CAPTION-BARU">Baru</label></a>
                <?php endif; ?>
            </div> -->
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                ...
                                <button type="button" id="btn-search-data-konversi" class="btn btn-success"><i class="fa fa-search"></i> <label name="CAPTION-CARI">Cari</label></button>
                            </div>
                        </div>
                    </div>
                    <br>
