    ...
    <div class="modal-dialog" style="width:90%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- filter data -->
                <?php $this->load->view("WMS/KoreksiPallet/component/Modal/SKU/filter_data") ?>

                <!-- list data -->
                <?php $this->load->view("WMS/KoreksiPallet/component/Modal/SKU/list_data") ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="handleGetPilihSKU()"><i class="fas fa-plus"></i> <label name="CAPTION-PILIH">Pilih</label></button>
