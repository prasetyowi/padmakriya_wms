	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 name="CAPTION-132002000">Download Canvas FAS</h3>
			</div>
				...
				<div class="x_panel">
					...
					<div class="row">
						<div class="col-md-8 col-sm-12">
							...
							<button type="button" id="btnsavecanvasfas" class="btn btn-primary"><i class="fa fa-save"></i> Download Canvas</button>
							<button type="button" id="btnsavecanvasdowms" class="btn btn-primary"><i class="fa fa-save"></i> Generate Canvas</button>
							<button type="button" id="btnrefreshcanvas" class="btn btn-primary"><i class="fa fa-refresh"></i> Refresh</button>
						...
						<div class="container">
							...
							<div class="tab-content">
								<div id="panel-in-do" class="tab-pane fade in active">
									<table id="table-canvas-in-do" width="100%" class="table table-striped">
										<thead>
											<tr>
												...
												<th class="text-center" name="CAPTION-NOCANVAS">CANVAS</th>
												<th class="text-center" name="CAPTION-TANGGALCANVAS">Tanggal Canvas</th>
								...
								<div id="panel-not-in-do" class="tab-pane fade">
									<table id="table-canvas-not-in-do" width="100%" class="table table-striped">
										<thead>
											<tr>
												<th class="text-center" name="CAPTION-NODO">DO</th>
												<th class="text-center" name="CAPTION-NOCANVAS">CANVAS</th>
