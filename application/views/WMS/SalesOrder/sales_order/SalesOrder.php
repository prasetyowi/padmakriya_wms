                ...
                <div class="x_panel">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12">
                            ...
                            <select class="form-control select2" id="filter_perusahaan" style="width:100%;" onchange="GetPrincipleByPerusahaan()">
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <select name="principle" class="form-control select2" id="principle" style="width:100%;">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <button type="button" id="btnsavesofas" class="btn btn-primary"><i class="fa fa-save"></i>
                                Unduh SO</button>
                            <button type="button" id="btnsavedowms" class="btn btn-primary"><i class="fa fa-save"></i>
                                Generate DO</button>
                    ...
                    <div class="row">
                        <div class="container">
                            <ul class="nav nav-tabs">
                                <li><a data-toggle="tab" href="#panel-in-do">In DO</a></li>
                                <li class="active"><a data-toggle="tab" href="#panel-not-in-do">Not In DO</a></li>
                            </ul>
                            <div class="clearfix"></div><br>
                            <div class="tab-content">
                                <div id="panel-in-do" class="tab-pane fade ">
                                ...
                                <div id="panel-not-in-do" class="tab-pane fade in active">
                                    <table id="table-so-not-in-do" width="100%" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" name="CAPTION-TIPE">Tipe</th>
                                                <th class="text-center" name="CAPTION-STATUS">Status</th>
                                                <th class="text-center" name="CAPTION-STATUSOUTLET"><input type="checkbox" name="select-so" id="select-sync-all-customer" value="1"> Status Outlet</th>
                                            </tr>
                                        </thead>
                                        <tbody>
...
<div class="modal fade" id="modal_result_message" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 80%;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title"><label name="CAPTION-PESANERRORDOUBAHDRAFT">Pesan Error</label></h4>
            </div>
            <div class="modal-body">
                <div class="row" id="panel-sku">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <table class="table table-bordered" id="table_result_message" style="width:100%;">
                                <thead>
                                    <tr class="bg-primary">
