                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-tr_konversi_sku_id">
                                    <label class="control-label" for="pembongkaran-tr_konversi_sku_id" name="CAPTION-KODE">No Persetujuan</label>
                                    <select name="pembongkaran[tr_konversi_sku_id]" class="form-control select2" id="pembongkaran-tr_konversi_sku_id" disabled>
                                        <option value="<?= $header['tr_konversi_sku_id'] ?>"><?= $header['tr_konversi_sku_kode'] ?></option>
                                    </select>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-tipe_konversi_id">
                                    ...
                                    <select disabled name="pembongkaran[tipe_konversi_id]" class="form-control" id="pembongkaran-tipe_konversi_id">
                                        <option value="<?= $header['tipe_konversi_id'] ?>"><?= $header['tipe_konversi_nama'] ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-tr_konversi_sku_keterangan">
                                    ...
                                    <textarea disabled rows="4" type="text" id="pembongkaran-tr_konversi_sku_keterangan" class="form-control" name="pembongkaran[tr_konversi_sku_keterangan]" autocomplete="off"><?= $header['tr_konversi_sku_keterangan'] ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <table class="table table-striped" id="table-sku-pembongkaran">
                        ...
                        <?php foreach ($KonversiDetail as $i => $detail) : ?>
                            <tr id="row-<?= $i ?>">
                                ...
                                <td style="text-align: center; vertical-align: middle;"><?= $detail['tr_konversi_sku_detail_qty_plan'] ?></td>
                                <td style="text-align: center; vertical-align: middle;">
...
<div class="modal fade" id="modal-konversi-detail" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                        ...
                        <table class="table table-striped" id="table-konversi-by-sku">
                            <thead>
                                <tr class="bg-primary">
                                    ...
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-PALLETTUJUAN">Pallet Tujuan</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
            ...
            <div class="modal-footer">
                <span id="loadingkonversi" style="display:none;"><i class="fa fa-spinner fa-spin"></i><label name="CAPTION-LOADING">Loading</label>...</span>
                <button type="button" class="btn btn-danger" id="btn_close_konversi_detail"><label name="CAPTION-TUTUP">Tutup</label></button>
            </div>
        </div>
    </div>
</div>
