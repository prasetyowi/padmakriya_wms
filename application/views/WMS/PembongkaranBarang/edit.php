...
<div class="right_col" role="main">
    <div class="">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-tr_konversi_sku_id">
                                    ...
                                    <select name="pembongkaran[tr_konversi_sku_id]" class="form-control select2" id="pembongkaran-tr_konversi_sku_id" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-tr_konversi_sku_keterangan">
                                    ...
                                    <textarea rows="1" type="text" id="pembongkaran-tr_konversi_sku_keterangan" class="form-control" name="pembongkaran[tr_konversi_sku_keterangan]" autocomplete="off"><?= $header['tr_konversi_sku_keterangan'] ?></textarea>
                                </div>
                                <div class="form-group field-pembongkaran-depo_detail_id">
                                    ...
                                    <select readonly="readonly" disabled id="pembongkaran-depo_detail_id" class="form-control select2" name="pembongkaran[depo_detail_id]">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-client_wms_id">
                                    ...
                                    <select readonly="readonly" disabled id="pembongkaran-client_wms_id" class="form-control select2" name="pembongkaran-[client_wms_id]">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-pembongkaran-depo_detail_id_tujuan">
                                    <label for="pembongkaran-depo_detail_id_tujuan" class="control-label" name="CAPTION-GUDANGTUJUAN">Gudang Tujuan</label>
                                    <input type="hidden" id="depo_detail_tujuan" name="depo_detail_tujuan" value="<?= $header['depo_detail_nama_tujuan'] ?>">
                                    <select readonly="readonly" disabled id="pembongkaran-depo_detail_id_tujuan" class="form-control select2" name="pembongkaran[depo_detail_id_tujuan]">
                                        <option value="<?= $header['depo_detail_id_tujuan'] ?>">
                                            <?= $header['depo_detail_nama_tujuan'] ?>
                                        </option>
                                    </select>
                                </div>
                            </div>
        ...
        <?php endforeach; ?>
        <?php foreach ($arr_detail1 as $key => $value) { ?>
            <?php foreach ($arr_detail2 as $key2 => $value2) { ?>
                <?php if ($value['tr_konversi_sku_detail_id'] == $value2['tr_konversi_sku_detail_id']) { ?>
                    <input type="hidden" class="index" id="index-<?= $key ?>" value="<?= $value['tr_konversi_sku_detail_id'] ?>" data-total1="<?= $value['total1'] ?>" data-total2="<?= $value2['total2'] ?>">
                <?php } ?>
            <?php } ?>
        <?php } ?>
        ...
        <div class="row" id="panel-sku">
            <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-striped" id="table-sku-pembongkaran">
                            ...
                            <?php foreach ($KonversiDetail as $i => $detail) : ?>
                                <tr id="row-<?= $i ?>">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <?= $detail['tr_konversi_sku_detail_qty_plan'] ?></td>
                                    <td style="text-align: center; vertical-align: middle;" id="qtyAmbilTD-<?= $i ?>">
                                        <?= $detail['tr_konversi_sku_detail2_qty'] ?>
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <?php if ($detail['tr_konversi_sku_detail_qty_plan'] == $detail['tr_konversi_sku_detail2_qty']) : ?>
                                            <button class="btn btn-primary btn-small" disabled id="btn-<?= $i ?>" onclick="GetSKUKonversi(<?= $i ?>)"><i class="fa fa-pencil"></i></button>
                                        <?php else : ?>
                                            <button class="btn btn-primary btn-small" id="btn-<?= $i ?>" onclick="GetSKUKonversi(<?= $i ?>)"><i class="fa fa-pencil"></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <div style="float: right">
                    ...
                    <button class="btn-submit btn btn-success" id="btn_update_konversi"><i class="fa fa-save"></i>
                        <label name="CAPTION-SIMPAN">Simpan</label></button>
                    <a href="<?= base_url('WMS/pembongkaranBarang/pembongkaranMenu') ?>" class="btn btn-danger"><i class="fa fa-reply"></i> <label name="CAPTION-KEMBALI">Kembali</label></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <input readonly="readonly" type="text" id="pembongkarandetail2-sku_kode" class="form-control" value="">
                                <input readonly="readonly" type="hidden" id="pembongkarandetail2-index" class="form-control" value="">
                                <input readonly="readonly" type="hidden" id="pembongkarandetail2-sku_stock_id" class="form-control" value="">
                            </div>
                            <div class="col-xs-4">
                                <label name="CAPTION-SKU">SKU</label>
                                <input readonly="readonly" type="text" id="pembongkarandetail2-sku_nama_produk" class="form-control" value="">
                            </div>
                            <div class="col-xs-4">
                                <label name="CAPTION-SKUREQEXPDATE">Tgl Kadaluwarsa SKU</label>
                                <input readonly="readonly" type="text" id="pembongkarandetail2-sku_stock_expired_date" class="form-control" value="">
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col-xs-3">
                                <label name="CAPTION-SATUAN">Satuan</label>
                                <input readonly="readonly" type="text" id="pembongkarandetail2-sku_satuan" class="form-control" value="">
                            </div>
                            <div class="col-xs-3">
                                <label name="CAPTION-KEMASAN">Kemasan</label>
                                <input readonly="readonly" type="text" id="pembongkarandetail2-sku_kemasan" class="form-control" value="">
                            </div>
                            <div class="col-xs-3">
                                <label name="CAPTION-QTY">Qty</label>
                                <input readonly="readonly" type="text" id="pembongkarandetail2-tr_konversi_sku_detail_qty_plan" class="form-control" value="">
                            </div>
                            <div class="col-xs-3">
                                <label name="CAPTION-QTYKONVERSI">Qty Konversi</label>
                                <input readonly="readonly" type="text" id="pembongkarandetail2-tr_konversi_sku_detail_qty_result" class="form-control" value="">
                                <input readonly="readonly" type="hidden" id="pembongkarandetail2-tr_konversi_sku_detail_qty_sisa" class="form-control" value="0">
                            </div>
                        </div>
                    </div>
                </div><br><br>
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kode_barcode" placeholder="PAL/00000001">
                                    ...
                                    <div class="col-md-6">
                                        <div style="margin-top: 23px;">
                                            <button type="button" class="btn btn-success" id="search_kode_pallet"><i class="fas fa-search"></i> <label name="CAPTION-CHECKKODE">Check
                                                    Kode</label></button>
                                            <button type="button" class="btn btn-success" id="check_kode" style="display: none;"><i class="fas fa-search"></i> <label name="CAPTION-CHECKKODE">Check Kode</label></button>
                    ...
                    <div class="col-xs-12">
                        <table class="table" id="table-konversi-detail">
                            <thead>
                                <tr class="bg-primary">
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-AREA">Area</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-LOKASIRAK">Lokasi Rak</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-LOKASIBIN">Lokasi Bin</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-NOPALLET">No. Pallet</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-LOCKED">Locked</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-QTY">Qty</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-QTYAMBIL">Qty Ambil</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-ACTION">Action</th>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" style="float: left;" id="btn_save_konversi_detail"><label name="CAPTION-SIMPAN">Simpan</label></button>
                <button type="button" data-dismiss="modal" class="btn btn-danger"><label name="CAPTION-BATAL">BATAL</label></button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="modal-konversi-detail" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title"><label name="CAPTION-KONVERSI">Konversi</label> || <span><strong id="namaSKU"></strong></span></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <input type="text" id="gudang_asal" class="form-control" readonly />
                            </div>
                            <div class="col-xs-6">
                                <label name="CAPTION-GUDANGTUJUAN">Gudang Tujuan</label>
                                <input type="text" id="gudang_tujuan" class="form-control" readonly />
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table class="table table-striped" id="table-konversi-by-sku" style="width: 100%;">
                            <thead>
                                <tr class="bg-primary">
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-PILIH">Pilih</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-QTY">Qty</th>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SATUANKONVERSI">Satuan Konversi</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-REQPALLETTUJUAN">Req Pallet Tujuan</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-PALLETTUJUAN" colspan="2">Pallet Tujuan</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
            ...
            <div class="modal-footer">
                <span id="loadingkonversi" style="display:none;"><i class="fa fa-spinner fa-spin"></i><label name="CAPTION-LOADING">Loading</label>...</span>
                <button type="button" class="btn btn-info" style="float: left;" id="btn_save_konversi_detail2"><label name="CAPTION-SIMPAN">Simpan</label></button>
                <button type="button" class="btn btn-danger" id="btn_close_konversi_detail"><label name="CAPTION-BATAL">Batal</label></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal_scan" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title" name="CAPTION-SCANLOKASIBINTUJUAN">Scan Lokasi Bin Tujuan</h4>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="manual_input_pallet" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title" name="CAPTION-CHECKPALLETTUJUAN">Check Pallet Tujuan</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label name="CAPTION-PALLET">Pallet</label>
                    <input type="text" class="form-control kode_pallet_by_one" id="kode_pallet_by_one" placeholder="PLT/0000001" />
                    <!-- <input type="text" class="form-control" id="kode_barcode2" placeholder="PAL/00000001">
                    <div style="max-height: 20vh;overflow:hidden;overflow-y:scroll">
