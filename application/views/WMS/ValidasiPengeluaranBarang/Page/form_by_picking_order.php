			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="container mt-2">
						<div class="row">
							<div class="col-md-xl-3 col-lg-3 col-md-3 col-sm-12 col-sm-12">
								<div class="form-group">
									<label name="CAPTION-NOSURATTUGASPENGIRIMAN">No. Surat Tugas Pengiriman</label>
									<input type="hidden" name="lastUpdated" id="lastUpdated" value="<?= $picking_order->picking_order_tgl_update ?>">
									<select class="form-control select2" name="noFDJR" id="noFDJR" required disabled onchange="handlerGetDataByFDJR(this.value)">
										<option value="">--Pilih No. Surat Tugas Pengiriman--</option>
										<?php foreach ($dataFDJR as $key => $value) { ?>
											<option value="<?= $value->id ?>" <?= $delivery_order_batch_id == $value->id ? 'selected' : '' ?>><?= $value->kode ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
							<div class="col-md-xl-3 col-lg-3 col-md-3 col-sm-12 col-sm-12">
								<div class="form-group">
									...
									<select class="form-control select2" name="noPPB" id="noPPB" required disabled onchange="handlerGetDataProsesValidasi(this.value)">
										<option value="<?= $picking_order_id ?>"><?= $picking_order->picking_order_kode ?></option>
									</select>
								</div>
							</div>
							<div class="col-md-xl-3 col-lg-3 col-md-3 col-sm-12 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="noSerahTerima" id="noSerahTerima" placeholder="No. Serah Terima" value="" disabled />
								</div>
							</div>
							<div class="col-md-xl-3 col-lg-3 col-md-3 col-sm-12 col-sm-12">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-xl-4 col-lg-4 col-md-4 col-sm-12 col-sm-12">
								<div class="form-group">
									...
									<input type="hidden" name="pickingOrderId" id="pickingOrderId" value="<?= $picking_order_id ?>">
									<input type="hidden" name="serahTerimaKirimId" id="serahTerimaKirimId" value="">
									<input type="text" class="form-control" name="driver" id="driver" placeholder="Driver" value="" disabled />
								</div>
							</div>
							<div class="col-md-xl-4 col-lg-4 col-md-4 col-sm-12 col-sm-12">
								<div class="form-group">
									<label name="CAPTION-TANGGALPENGIRIMAN">Tanggal pengiriman</label>
									<input type="date" class="form-control" name="tglPengiriman" id="tglPengiriman" placeholder="Tgl Pengiriman" value="" disabled />
								</div>
							</div>
						</div>
					</div>
