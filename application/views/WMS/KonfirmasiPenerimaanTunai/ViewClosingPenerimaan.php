<div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="text" id="no_fdjr" class="form-control" name="no_fdjr" autocomplete="off"
                                    readonly>
                                <input type="hidden" id="id_do_batch" class="form-control" name="id_do_batch"
                                    autocomplete="off" value="<?= $id ?>" readonly>
                                <input type="hidden" id="lastUpdateTgl" class="form-control" name="lastUpdateTgl"
                                    autocomplete="off" value="<?= $lastUpdate['tglUpd'] ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align"
                                name="CAPTION-TANGGALFDJR">Tanggal
                                FDJR</label>
                            <div class="col-md-6 col-sm-6">
                                <input type="text" id="tgl_fdjr" class="form-control" name="tgl_fdjr" autocomplete="off"
                                    readonly>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align" name="CAPTION-STATUSFDJR">Status
                                FDJR</label>
                            <div class="col-md-6 col-sm-6">
                                <select disabled id="status_fdjr" name="status_fdjr" class="form-control select2"
                                    style="width:100%">
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select disabled id="armada" name="armada" class="form-control select2"
                                    style="width:100%">
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align"
                                name="CAPTION-PENGEMUDI">Pengemudi</label>
                            <div class="col-md-6 col-sm-6">
                                <select disabled id="pengemudi" name="pengemudi" class="form-control select2"
                                    style="width:100%">
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align"
                                name="CAPTION-JUMLAHTERIMA">Jumlah
                                Terima</label>
                            <div class="col-md-6 col-sm-6">
                                <input type="number" oninput="this.value = Math.abs(this.value)" value="0"
                                    id="viewJumlahTerima" class="form-control" name="viewJumlahTerima"
                                    autocomplete="off" disabled>
                                <input type="hidden" value="0" id="delivery_order_batch_nominal_invoice"
                                    class="form-control" name="delivery_order_batch_nominal_invoice" autocomplete="off"
                                    disabled>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="x_panel">
            ...
            <div class="form-horizontal form-label-left">
                <span id="loadingaddpembayaran" style="display:none;"><i class="fa fa-spinner fa-spin"></i><span
                        name="CAPTION-LOADING">Loading</span>...</span>
                <button style="display: none;" type="button" class="btn btn-success" id="btn_add_pembayaran"><i
                        class="fa fa-plus"></i> <span name="CAPTION-TAMBAHPEMBAYARAN">Tambah Pembayaran</span></button>
                <div class="row">
        ...
        <div style="float: right;">
            <div class="">
                <span id="loadingsimpanpembayaran" style="display:none;"><i class="fa fa-spinner fa-spin"></i><span
                        name="CAPTION-LOADING">Loading</span>...</span>
                <button type="button" class="btn btn-success" id="btn_simpan_all"><i class="fa fa-save"></i> <span
                        name="CAPTION-SIMPAN">Simpan</span></button>
                <a href="<?= base_url(); ?>WMS/KonfirmasiPenerimaanTunai/KonfirmasiPenerimaanTunaiMenu"
                    class="btn btn-info" id="btn_kembali"><i class="fa fa-reply"></i>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <table class="table table-striped" id="table_list_pembayaran_detail">
                                <thead>
                                    <tr class=" bg-primary">
                                        <th class="text-center" style="color:white;"><input type="checkbox"
                                                name="select-do" id="select-do" value="1"></th>
                                        ...
                                        <th class="text-center" style="color:white;"><span
                                                name="CAPTION-NOSOEKSTERNAL">No. SO
                                                Eksternal</span></th>
                                        <th class="text-center" style="color:white;"><span
                                                name="CAPTION-OUTLET">Outlet</span>
                                        </th>
                                        <th class="text-center" style="color:white;"><span
                                                name="CAPTION-TIPEPEMBAYARAN">Tipe
                                                Pembayaran</span></th>
                                        <th class="text-center" style="color:white;" name="CAPTION-TIPEDO">Tipe DO</th>
                                        <th class="text-center" style="color:white;"><span
                                                name="CAPTION-TOTALBAYAR">Total
                                                Bayar</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" id="btn_update_list_pembyaran_detail"
                        onclick="UpdateListPembayaranDetail()"><i class="fa fa-save"></i> <span
                            name="CAPTION-SIMPAN">Simpan</span></button>
                    <button type="button" data-dismiss="modal" class="btn btn-danger"
                        id="btn_close_list_pembyaran_detail"><i class="fa fa-times"></i> <span
                            name="CAPTION-TUTUP">Tutup</span></button>
                </div>
            </div>
        </div>
    </div>
