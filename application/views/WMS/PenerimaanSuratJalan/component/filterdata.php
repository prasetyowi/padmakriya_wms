      ...
      <div class="container mt-2">
        <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="tahun_filter" id="tahun_filter" required>
                    <option value="">--<label name="CAPTION-PILIHTAHUN">Pilih Tahun</label>--</option>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-xs-12">
            ...
            <div class="form-group">
              ...
              <select name="status_filter" id="status_filter" class="form-control select2">
                ...
                <option value="Open"><label name="CAPTION-OPEN">Open</label></option>
                <option value="Close"><label name="CAPTION-CLOSE">Close</label></option>
              </select>
            </div>
          </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
            ...
            <span id="loadingsearch" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <label name="CAPTION-LAODING">Loading</label>...</span>
