                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="tipe_penerimaan_id_view" id="tipe_penerimaan_id_view" data-tipe="<?= implode(",", $data_detail) ?>">
                                    <input type="hidden" name="count_error" id="count_error_view" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-control select2 tipe_gudang_view" name="tipe_gudang_view" id="tipe_gudang_view" required></select>
                                </div>
                            </div>
                        </div>
                    </div>
