					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-lg-3 col-xs-12">
								...
								<select id="filter_tipe_gudang" name="filter_tipe_gudang" class="form-control select2">
	...
	<div class="modal-dialog modal-lg" style="width:90%;">
		<div class="modal-content">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="form-group">
								<div class="row">
									<div class="col-xs-4">
										<label name="CAPTION-SKUKONVERSIGROUP">SKU Konversi Group</label>
										<input type="text" id="DetailSKUHeader-sku_konversi_group" class="form-control" name="DetailSKUHeader-sku_konversi_group" value="" disabled>
										<input type="hidden" id="DetailSKUHeader-sku_id" class="form-control" name="DetailSKUHeader-sku_id" value="" disabled>
										<input type="hidden" id="DetailSKUHeader-is_flag" class="form-control" name="DetailSKUHeader-is_flag" value="" disabled>
									</div>
									<div class="col-xs-4">
							...
							<table class="table table-bordered" id="table-detail-sku">
								<thead>
									<tr class="bg-primary">
										...
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-EDITBYSKUGROUP">Edit By SKU Group</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
			...
			<div class="modal-footer">
				...
				<button type="button" data-dismiss="modal" class="btn btn-danger" id="btn_tutup_do_prioritas_stok" onclick="TutupDOPrioritasStok()"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
			</div>
		</div>
	</div>
</div>

<div class="modal fade" id="modal-detail-sku-group" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" style="width:90%;">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<h4 class="modal-title"><label name="CAPTION-LISTSKUGROUP">List SKU Group</label></h4>
			</div>
			<div class="modal-body">
				<div class="row" id="panel-sku">
					<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-4">
										...
										<input type="text" id="DetailSKUGroupHeader-delivery_order_draft_kode" class="form-control" name="DetailSKUGroupHeader-delivery_order_draft_kode" value="" disabled>
										<input type="hidden" id="DetailSKUGroupHeader-delivery_order_detail_draft_id" class="form-control" name="DetailSKUGroupHeader-delivery_order_detail_draft_id" value="" disabled>
										<input type="hidden" id="DetailSKUGroupHeader-delivery_order_draft_id" class="form-control" name="DetailSKUGroupHeader-delivery_order_draft_id" value="" disabled>
										<input type="hidden" id="DetailSKUGroupHeader-sku_id" class="form-control" name="DetailSKUGroupHeader-sku_id" value="" disabled>
									</div>
									<div class="col-xs-4">
										<label name="CAPTION-SKUKODE">SKU Kode</label>
										<input type="text" id="DetailSKUGroupHeader-sku_kode" class="form-control" name="DetailSKUGroupHeader-sku_kode" value="" disabled>
										<input type="hidden" id="DetailSKUGroupHeader-sku_id" class="form-control" name="DetailSKUGroupHeader-sku_id" value="" disabled>
									</div>
									<div class="col-xs-4">
										<label name="CAPTION-SKU">SKU</label>
										<input type="text" id="DetailSKUGroupHeader-sku_nama_produk" class="form-control" name="DetailSKUGroupHeader-sku_nama_produk" value="" disabled>
									</div>
								</div><br>
								<div class="row">
									<div class="col-xs-4">
										<label name="CAPTION-SKUKEMASAN">SKU Kemasan</label>
										<input type="text" id="DetailSKUGroupHeader-sku_kemasan" class="form-control" name="DetailSKUGroupHeader-sku_kemasan" value="" disabled>
									</div>
									<div class="col-xs-4">
										<label name="CAPTION-SKUSATUAN">SKU Satuan</label>
										<input type="text" id="DetailSKUGroupHeader-sku_satuan" class="form-control" name="DetailSKUGroupHeader-sku_satuan" value="" disabled>
									</div>
									<!-- <div class="col-xs-4">
										<label name="CAPTION-SKUSTOCKQTY">SKU Stock Qty</label>
										<input type="text" id="DetailSKUGroupHeader-sku_stock_qty" class="form-control" name="DetailSKUGroupHeader-sku_stock_qty" value="" disabled>
									</div> -->
								</div><br>
							</div>
						</div>
						<div class="x_panel">
							<table class="table table-bordered" id="table-detail-sku-group">
								<thead>
									<tr class="bg-primary">
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-NO">No</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUKONVERSIGROUP">SKU Konversi Group</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUKODE">SKU Kode</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKU">SKU</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUKEMASAN">SKU Kemasan</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUSATUAN">SKU Satuan</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUSTOCKQTY">SKU Stock Qty</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-QTYEDIT">Qty Edit</th>
										<th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-QTYSISA">Qty Sisa</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success" id="btn_simpan_do_prioritas_stok_by_sku_group" onclick="saveDODetailRevisi()"><i class="fa fa-save"></i> <span name="CAPTION-SIMPAN">Simpan</span></button>
...
<div class="modal fade" id="modal_response_message_pembatalan_do_revisi" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" style="width: 80%;">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<h4 class="modal-title"><label name="CAPTION-PESANERRORREVISISKUDELIVERYORDER">Pesan Error Revisi SKU Delivery Order</label></h4>
			</div>
			<div class="modal-body">
				<div class="row" id="panel-sku">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<table class="table table-bordered" id="table_response_message_pembatalan_do_revisi" style="width:100%;">
								<thead>
									<tr class="bg-primary">
