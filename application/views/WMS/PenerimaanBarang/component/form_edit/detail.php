<div class="col-md-12 col-sm-12 col-xs-12" id="showfilterdataedit" style="margin-top: 10px;display:none">
    <div class="x_panel">
        <div class="container mt-2">
            <div class="row" style="float: right">
                <button type="button" class="btn btn-primary" id="tambah_pallet_edit"><i class="fas fa-plus"></i> <label name="CAPTION-TAMBAHPENERIMAANPERPALLET">Tambah Penerimaan Per Pallet</label></button>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="x_content table-responsive">
                    <table id="tablelistdatadetailsjedit" width="100%" class="table table-striped">
                        <thead>
                            <tr class="text-center">
                                <td><strong><label name="CAPTION-NO">No</label></strong></td>
                                <td><strong><label name="CAPTION-KODE">Kode</label></strong></td>
