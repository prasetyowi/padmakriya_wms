            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 col-xs-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_wms_sku" id="kode_wms_sku" placeholder="Kode SKU WMS"
                            class="form-control">
                    </div>

                    <div class="form-group">
                        <label name="CAPTION-KODESKUPABRIK">Kode SKU Pabrik</label>
                        <input type="text" name="kode_pabrik_sku" id="kode_pabrik_sku" placeholder="Kode SKU Pabrik"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xs-12 col-sm-12">
                    <div style="margin-top: 10px;">
                        <button class="btn btn-primary" id="search_filter_data_sku"><i class="fas fa-search"></i> <label
                                name="CAPTION-FILTER">Filter</label></button>
                        <span id="loadingsearchsku" style="display:none;"><i class="fa fa-spinner fa-spin"></i> <label
