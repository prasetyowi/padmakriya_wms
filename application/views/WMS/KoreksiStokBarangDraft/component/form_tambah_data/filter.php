                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-xl-4 col-xs-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="no_koreksi_draft" id="no_koreksi_draft" value="Auto" readonly required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label name="CAPTION-TANGGAL">Tanggal</label>
                                    <input type="date" class="form-control" name="koreksi_draft_tgl" id="koreksi_draft_tgl" value="<?= getLastTbgDepo() ?>" readonly required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="gudang_koreksi_draft" name="gudang_koreksi_draft" class="form-control select2">
                        ...
                        <div class="form-group">
                            ...
                            <select id="koreksi_draft_principle" name="koreksi_draft_principle" class="form-control select2">
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <select id="koreksi_draft_checker" name="koreksi_draft_checker" class="form-control select2">
                            </select>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="koreksi_draft_tipe_transaksi" name="koreksi_draft_tipe_transaksi" class="form-control select2" onchange="changeHandlerTypeTransaction(event)">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="koreksi_draft_status" value="Draft" id="koreksi_draft_status" readonly required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea cols="10" style="width: 100%;height: 103px" class="form-control" name="koreksi_draft_keterangan" id="koreksi_draft_keterangan" placeholder="Keterangan"></textarea>
                        </div>
