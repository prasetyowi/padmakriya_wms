        ...
        <div class="x_panel">
            <div class="x_title">
                <div style="float: left">
                    <button type="button" class="btn btn-info" id="pilih_sku_koreksi_draft_edit"><i
                            class="fas fa-save"></i> <label name="CAPTION-PILIHSKU">Pilih SKU</label></button>
                </div>
            ...
            <div class="container mt-2">
                <div class="row" style="margin-top: 10px;">
                    <div class="x_content table-responsive">
                        <table id="list_data_tambah_koreksi_stok_edit" width="100%" class="table table-striped">
                            <thead>
                                <tr>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="9" class="text-center bg-success" id="total_detail_sku_edit"></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                ...
                <div style="float: right">
                    <button type="button" class="btn btn-success" id="edit_koreksi_draft_edit"><i
                            class="fas fa-save"></i> <label name="CAPTION-EDITDATA">Edit Data</label></button>
                    <button type="button" class="btn btn-dark" id="kembali_koreksi_draft_edit"><i
