    ...
    <div class="">
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_kode">
                                ...
                                <input readonly="readonly" type="text" id="deliveryorderdraft-delivery_order_kode"
                                    class="form-control input-sm" name="DeliveryOrderDraft[_delivery_order_kode]"
                                    autocomplete="off" value="<?= $header['delivery_order_kode']; ?>" readonly>
                                <input readonly="readonly" type="hidden" id="deliveryorderdraft-delivery_order_id"
                                    class="form-control input-sm" name="DeliveryOrderDraft[_delivery_order_id]"
                                    autocomplete="off" value="<?= $header['delivery_order_id']; ?>">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_status">
                                ...
                                <input readonly="readonly" type="text" id="deliveryorderdraft-delivery_order_status"
                                    class="form-control input-sm" name="DeliveryOrderDraft[delivery_order_status]"
                                    autocomplete="off" value="<?= $header['delivery_order_status']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_tgl_buat_do">
                                ...
                                <input type="text" id="deliveryorderdraft-delivery_order_tgl_buat_do"
                                    class="form-control input-sm datepicker"
                                    name="DeliveryOrderDraft[_delivery_order_tgl_buat_do]" autocomplete="off"
                                    value="<?= $header['delivery_order_tgl_buat_do']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_tgl_expired_do">
                                <label class="control-label" for="deliveryorderdraft-delivery_order_tgl_expired_do"
                                    name="CAPTION-TANGGALEXPIRED">Tanggal Expired</label>
                                <input type="text" id="deliveryorderdraft-delivery_order_tgl_expired_do"
                                    class="form-control input-sm datepicker"
                                    name="DeliveryOrderDraft[_delivery_order_tgl_expired_do]" autocomplete="off"
                                    value="<?= $header['delivery_order_tgl_expired_do']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_tgl_surat_jalan">
                                <label class="control-label" for="deliveryorderdraft-delivery_order_tgl_surat_jalan"
                                    name="CAPTION-TANGGALSURATJALAN">Tanggal Surat Jalan</label>
                                <input type="text" id="deliveryorderdraft-delivery_order_tgl_surat_jalan"
                                    class="form-control input-sm datepicker"
                                    name="DeliveryOrderDraft[_delivery_order_tgl_surat_jalan]" autocomplete="off"
                                    value="<?= $header['delivery_order_tgl_surat_jalan']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_tgl_rencana_kirim">
                                <label class="control-label" for="deliveryorderdraft-delivery_order_tgl_rencana_kirim"
                                    name="CAPTION-TANGGALRENCANAKIRIM">Tanggal Rencana Kirim</label>
                                <input type="text" id="deliveryorderdraft-delivery_order_tgl_rencana_kirim"
                                    class="form-control input-sm datepicker"
                                    name="DeliveryOrderDraft[_delivery_order_tgl_rencana_kirim]" autocomplete="off"
                                    value="<?= $header['delivery_order_tgl_rencana_kirim']; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group field-deliveryorderdraft-delivery_order_keterangan">
                                ...
                                <textarea rows="5" type="text" id="deliveryorderdraft-delivery_order_keterangan"
                                    class="form-control input-sm" name="DeliveryOrderDraft[_delivery_order_keterangan]"
                                    autocomplete="off" readonly><?= $header['delivery_order_keterangan'] ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_tipe_pembayaran">
                                <label for="deliveryorderdraft-delivery_order_tipe_pembayaran" class="control-label"
                                    name="CAPTION-TIPEPEMBAYARAN">Tipe Pembayaran</label>
                                <fieldset>
                                    <label>
                                        <input class="radio-payment-type" type="radio"
                                            name="DeliveryOrderDraft[_delivery_order_tipe_pembayaran]"
                                            id="deliveryorderdraft-delivery_order_tipe_pembayaran" value="0"
                                            <?= $header['delivery_order_tipe_pembayaran'] == 0 ? 'checked' : '' ?>
                                ...
                                <fieldset>
                                    <label>
                                        <input class="radio-payment-type" type="radio"
                                            name="DeliveryOrderDraft[_delivery_order_tipe_pembayaran]"
                                            id="deliveryorderdraft-delivery_order_tipe_pembayaran" value="1"
                                            <?= $header['delivery_order_tipe_pembayaran'] == 1 ? 'checked' : '' ?>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_tipe_layanan">
                                <label for="deliveryorderdraft-delivery_order_tipe_layanan" class="control-label"
                                ...
                                <fieldset>
                                    <label>
                                        <input class="radio-service-type" type="radio"
                                            id="deliveryorderdraft-delivery_order_tipe_layanan"
                                            name="DeliveryOrderDraft[_delivery_order_tipe_layanan]"
                                            value="<?= $row['tipe_layanan_nama'] ?>" onclick="getCustomer();"
                                            <?= $header['delivery_order_tipe_layanan'] == $row['tipe_layanan_nama'] ? 'checked' : '' ?>
                        ...
                        <div class="col-xs-3" id="tunai">
                            <div class="form-group">
                                ...
                                <input type="number" readonly id="input_tunai" class="form-control input-sm"
                                    ...
                                    value="<?= round($header['delivery_order_nominal_tunai']) ?>">
                            </div>
                        </div>
                        <?php if ($header['delivery_order_attachment']) { ?>
                        <div class="col-xs-3">
                            <div class="form-group">
                                <label for="" name="CAPTION-FILEATTACHMENT">File Attachment</label>
                                <br>
                                <div id="hide-file">
                                    <a href="<?= base_url('assets/images/uploads/Invoice/') . $header['delivery_order_attachment'] ?>"
                                        target="_blank"><?= $header['delivery_order_attachment'] ?></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
        ...
        <div class="row" id="panel-customer" style="<?= $header['client_pt_id'] == '' ? 'display:none;' : '' ?>">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_nama]"
                        id="deliveryorderdraft-delivery_order_kirim_nama"
                        value="<?= $header['delivery_order_kirim_nama']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_alamat]"
                        id="deliveryorderdraft-delivery_order_kirim_alamat"
                        value="<?= $header['delivery_order_kirim_alamat']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_provinsi]"
                        id="deliveryorderdraft-delivery_order_kirim_provinsi"
                        value="<?= $header['delivery_order_kirim_provinsi']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kota]"
                        id="deliveryorderdraft-delivery_order_kirim_kota"
                        value="<?= $header['delivery_order_kirim_kota']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kecamatan]"
                        id="deliveryorderdraft-delivery_order_kirim_kecamatan"
                        value="<?= $header['delivery_order_kirim_kecamatan']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kelurahan]"
                        id="deliveryorderdraft-delivery_order_kirim_kelurahan"
                        value="<?= $header['delivery_order_kirim_kelurahan']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_kodepos]"
                        id="deliveryorderdraft-delivery_order_kirim_kodepos"
                        value="<?= $header['delivery_order_kirim_kodepos']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_area]"
                        id="deliveryorderdraft-delivery_order_kirim_area"
                        value="<?= $header['delivery_order_kirim_area']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_kirim_telepon]"
                        id="deliveryorderdraft-delivery_order_kirim_telepon"
                        value="<?= $header['delivery_order_kirim_telp']; ?>" />
        ...
        <div class="row" id="panel-factory" style="<?= $header['pabrik_id'] == '' ? 'display:none;' : '' ?>">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_nama]"
                        id="deliveryorderdraft-delivery_order_ambil_nama"
                        value="<?= $header['delivery_order_ambil_nama']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_alamat]"
                        id="deliveryorderdraft-delivery_order_ambil_alamat"
                        value="<?= $header['delivery_order_ambil_alamat']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_provinsi]"
                        id="deliveryorderdraft-delivery_order_ambil_provinsi"
                        value="<?= $header['delivery_order_ambil_provinsi']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kota]"
                        id="deliveryorderdraft-delivery_order_ambil_kota"
                        value="<?= $header['delivery_order_ambil_kota']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kecamatan]"
                        id="deliveryorderdraft-delivery_order_ambil_kecamatan"
                        value="<?= $header['delivery_order_ambil_kecamatan']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kelurahan]"
                        id="deliveryorderdraft-delivery_order_ambil_kelurahan"
                        value="<?= $header['delivery_order_ambil_kelurahan']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_kodepos]"
                        id="deliveryorderdraft-delivery_order_ambil_kodepos"
                        value="<?= $header['delivery_order_ambil_kodepos']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_telepon]"
                        id="deliveryorderdraft-delivery_order_ambil_telepon"
                        value="<?= $header['delivery_order_ambil_telp']; ?>" />
                    <input type="hidden" name="DeliveryOrderDraft[_delivery_order_ambil_area]"
                        id="deliveryorderdraft-delivery_order_ambil_area"
                        value="<?= $header['delivery_order_ambil_area']; ?>" />
        ...
        <div class="row" id="panel-sku">
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <table class="table table-striped" id="table-sku-delivery-only">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-center" style="color:white;"><label name="CAPTION-QTYREQ">Qty
                                        Req</label></th>
                                <?php if ($header['delivery_order_status'] == 'partially delivered') { ?>
                                <th class="text-center" style="color:white;"><label name="CAPTION-QTYKIRIM">Qty
                                        Kirim</label></th>
                                <?php } ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr id="row-<?= $i ?>" class="row-item">
                                ...
                                <?php if ($header['delivery_order_status'] == 'partially delivered') { ?>
                                <td class="text-center"><input type="number"
                                        id="item-<?= $i ?>-DeliveryOrderDetailDraft-sku_qty_kirim"
                                        class="form-control sku-qty-kirim" value="<?= $detail['sku_qty_kirim']; ?>"
                                        readonly /></td>
                                <?php } ?>
                            </tr>
                            <?php endforeach; ?>
                ...
                <div style="float: right">
                    <a href="<?= base_url('WMS/KelolaDOGagal/KelolaDOGagalMenu') ?>" class="btn btn-info"><i
