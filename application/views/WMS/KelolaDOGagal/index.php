	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 name="CAPTION-109018000">Kelola DO Gagal Kirim</h3>
			</div>
					...
					<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								...
								<select id="filter-do-perusahaan" name="filter_do_perusahaan" class="form-control select2" onchange="getPrincipleByPerusahaan()">
									<option value=""><label name="CAPTION-SEMUA">Semua</label></option>
									<?php foreach ($Perusahaan as $value) : ?>
										<option value="<?= $value['client_wms_id'] ?>">
											<?= $value['client_wms_nama'] ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							<div class="col-xs-3">
								<label name="CAPTION-PRINCIPLE">Principle</label>
								<select id="filter-do-principle" name="filter_do_principle" class="form-control select2">
									<option value=""><label name="CAPTION-SEMUA">Semua</label></option>
								</select>
							</div>
						</div>
