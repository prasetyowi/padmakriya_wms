<script>
	...
	const handlerFilterData = (event) => {
		...
		$.ajax({
			async: false,
			type: 'POST',
			url: "<?= base_url('WMS/LaporanTransaksi/LaporanLeadTimeDO/Get_laporan_lead_time_do') ?>",
			dataType: "JSON",
			data: {
	...
	function GetDetailLaporan(tipe, range) {
		if (tipe == "SO Approved") {
			...
			$('#table_laporan_lead_time_do_detail_so').DataTable({
				...
				'processing': true,
				'ajax': {
					url: "<?= base_url('WMS/LaporanTransaksi/LaporanLeadTimeDO/Get_laporan_lead_time_do_detail_so_approved') ?>",
					data: {
						filter_stock_tanggal: $('#filter_stock_tanggal').val(),
						principle_id: $('#filter_stock_principle option:selected').val(),
						tipe: tipe,
			...
			$('#table_laporan_lead_time_do_detail_so').DataTable({
				...
				'processing': true,
				'ajax': {
					url: "<?= base_url('WMS/LaporanTransaksi/LaporanLeadTimeDO/Get_laporan_lead_time_do_detail_so_approved_belum_punya_do_draft') ?>",
					data: {
						filter_stock_tanggal: $('#filter_stock_tanggal').val(),
						principle_id: $('#filter_stock_principle option:selected').val(),
						tipe: tipe,
			...
			$('#table_laporan_lead_time_do_detail_do').DataTable({
				...
				'serverMethod': 'post',
				'ajax': {
					url: "<?= base_url('WMS/LaporanTransaksi/LaporanLeadTimeDO/Get_laporan_lead_time_do_detail_so_approved_jadi_do_draft') ?>",
					data: {
						filter_stock_tanggal: $('#filter_stock_tanggal').val(),
						principle_id: $('#filter_stock_principle option:selected').val(),
						tipe: tipe,
			...
			$('#table_laporan_lead_time_do_detail_do').DataTable({
				...
				'serverMethod': 'post',
				'ajax': {
					url: "<?= base_url('WMS/LaporanTransaksi/LaporanLeadTimeDO/Get_laporan_lead_time_do_detail_do_draft_approved') ?>",
					data: {
						filter_stock_tanggal: $('#filter_stock_tanggal').val(),
						principle_id: $('#filter_stock_principle option:selected').val(),
						tipe: tipe,
			...
			$('#table_laporan_lead_time_do_detail_do').DataTable({
				...
				'serverMethod': 'post',
				'ajax': {
					url: "<?= base_url('WMS/LaporanTransaksi/LaporanLeadTimeDO/Get_laporan_lead_time_do_detail_do_dilaksanakan') ?>",
					data: {
						filter_stock_tanggal: $('#filter_stock_tanggal').val(),
						principle_id: $('#filter_stock_principle option:selected').val(),
						tipe: tipe,
