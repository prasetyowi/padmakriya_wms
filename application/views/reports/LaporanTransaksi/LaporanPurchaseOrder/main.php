<div class="right_col" role="main">
	...
	<div class="page-title">
		<div class="title_left">
			<h3 name="CAPTION-LAPORANTRANSAKSIPURCHASEORDER">Laporan Transaksi Purchase Order</h3>
		</div>
	</div>
						...
						<table id="table_detail" width="100%" class="table table-striped text-center">
							<thead>
								<tr style="background:#F0EBE3;">
									...
									<th class="text-center" name="CAPTION-ALAMATOUTLET">Alamat Outlet</th>
									<th class="text-center" name="CAPTION-AREA">Area</th>
									<th class="text-center" name="CAPTION-KODEPRODUCT">Kode Product</th>
									<th class="text-center" name="CAPTION-NAMAPRODUCT">Nama Product</th>
									<th class="text-center" name="CAPTION-QTYSO">QTY SO</th>
									<th class="text-center" name="CAPTION-TOTALHARGASO">Total Harga SO</th>
									<th class="text-center" name="CAPTION-QTYDO">QTY DO</th>
									<th class="text-center" name="CAPTION-TOTALHARGADO">Total Harga DO</th>
									<th class="text-center" name="CAPTION-ED">ED</th>
									<th class="text-center" name="CAPTION-STATUSDO">Status DO</th>
