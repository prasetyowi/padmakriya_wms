			...
			<div class="panel-body form-horizontal form-label-left">
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label class="col-form-label col-md-4 col-sm-4 label-align" name="CAPTION-TIPEGUDANG">Tipe Gudang</label>
							<div class="col-md-8 col-sm-8">
								<select class="form-control select2" id="filter_tipe_gudang" name="filter_tipe_gudang" style="width:100%">
									<option value=""><label name="CAPTION-PILIH">Pilih</label></option>
									<?php foreach ($TipeGudang as $row) { ?>
										<option value="<?= $row['tipegudang_kode']; ?>"><?= $row['tipegudang_nama']; ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
