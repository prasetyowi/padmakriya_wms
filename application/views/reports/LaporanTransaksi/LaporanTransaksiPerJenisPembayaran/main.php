<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 name="CAPTION-101002019">Laporan Transaksi Per Jenis Pembayaran</h3>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="x_content table-responsive">
							<table id="table_detail" width="100%" class="table table-bordered text-center">
								<thead>
	...
	<div class="modal fade" id="modal_detail_laporan" role="dialog" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-lg" style="width:95%;">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h4 class="modal-title inputTitle">Detail Laporan Transaksi Per Jenis Pembayaran</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 table-responsive">
							<table id="table_detail_laporan" width="100%" class="table table-bordered text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										<th class="text-center">No</th>
										<th class="text-center" name="CAPTION-NODO">No. DO</th>
										<th class="text-center" name="CAPTION-TGLAKTUALKIRIM">Tanggal Aktual Kirim</th>
										<th class="text-center" name="CAPTION-TANGGALEXPIRED">Tanggal Kadaluarsa</th>
										<th class="text-center" name="CAPTION-DRIVER">Pengemudi</th>
										<th class="text-center" name="CAPTION-OUTLET">Outlet</th>
										<th class="text-center" name="CAPTION-ALAMAT">Alamat</th>
										<th class="text-center" name="CAPTION-KELURAHAN">Kelurahan</th>
										<th class="text-center" name="CAPTION-KECAMATAN">Kecamatan</th>
										<th class="text-center" name="CAPTION-KOTA">Kota</th>
										<th class="text-center" name="CAPTION-PROVINSI">Provinsi</th>
										<th class="text-center" name="CAPTION-PRINCIPLE">Principle</th>
										<th class="text-center" name="CAPTION-NOMINALTUNAI">Nominal Tunai</th>
