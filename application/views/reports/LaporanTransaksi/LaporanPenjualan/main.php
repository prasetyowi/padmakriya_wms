	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 name="CAPTION-LAPORANTRANSAKSIPENJUALAN">Laporan Transaksi Penjualan</h3>
			</div>
		</div>
		...
		<div class="panel panel-default panel-stock-rekap">
			<div class="panel-body form-horizontal form-label-left">
				<div class="clearfix"></div>
				<button style="float: right;" class="btn btn-success" onclick="exportExcel()">Export <i class="fa-solid fa-file-excel"></i></button>
				<div class="row">
					<div class="col-xs-12">
							...
							<table id="table_detail" width="100%" class="table table-striped text-center">
								<thead>
									<tr style="background:#F0EBE3;">
										...
										<th class="text-center" name="CAPTION-TANGGALSURATTUGASPENGIRIMAN">Tgl. FDJR</th>
