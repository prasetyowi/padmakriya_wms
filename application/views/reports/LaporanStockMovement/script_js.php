<script type="text/javascript">
	...
	function GetLaporanStockRekapData() {
		...
		$('#table_stock_rekap > tbody').empty('');

		if ($.fn.DataTable.isDataTable('#table_stock_rekap')) {
			$('#table_stock_rekap').DataTable().clear();
	...
	function GetLaporanStockDetailData() {
		...
		$('#table_stock_detail > tbody').empty('');

		if ($.fn.DataTable.isDataTable('#table_stock_detail')) {
			$('#table_stock_detail').DataTable().clear();
