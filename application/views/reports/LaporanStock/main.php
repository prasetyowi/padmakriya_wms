    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-MENUSTOCKAKHIR">Menu Stock Akhir</h3>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input type="text" class="form-control" id="filter_stock_tanggal"
                                    name="filter_stock_tanggal" value="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-4 col-sm-4 label-align" name="CAPTION-PT">PT</label>
                            <div class="col-md-8 col-sm-8">
                                <select class="form-control select2" id="filter_stock_pt" name="filter_stock_pt"
                                    style="width:100%">
                     ...
                     <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <select class="form-control select2" id="filter_stock_gudang" name="filter_stock_gudang"
                                    style="width:100%">
                                    <option value=""><label name="CAPTION-ALL">All</label></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <button type="button" id="btn_stock_pencarian" class="btn btn-primary"><i
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <select class="form-control select2" name="filter_stock_opsi" id="filter_stock_opsi"
                                    style="width:100%">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <select class="form-control select2" id="filter_stock_principle"
                                    name="filter_stock_principle" style="width:100%">
                                    <option value=""><label name="CAPTION-ALL">All</label></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" class="form-control col=lg-2 col-md-2 col-sm-2"
                                            id="filter_stock_sku_kode" name="filter_stock_sku_kode" placeholder="Kode"
                                            value="" />
                                    </div>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control col=lg-4 col-md-4 col-sm-4"
                                            id="filter_stock_sku_nama" name="filter_stock_sku_nama" placeholder="SKU"
                                            value="" />
                                    </div>
                                </div>
                            </div>
