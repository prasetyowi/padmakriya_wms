...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h3 name="CAPTION-INFORMASIPALLET">Informasi Pallet</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-xs-12">
                        ...
                        <!-- <div class="row" style="float: right;">
                                <button type="button" disabled class="btn btn-primary" id="release_pallet"><i class="fas fa-qrcode"></i> <label name="CAPTION-RELEASEPALLET">Release
                                        Pallet</label></button>
                            </div> -->
                    </div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="pull-right"><button data-toggle="modal" data-target="#modal-history-pallet"
                            id="btn-history-pallet" class="btn btn-success" type="button"><i class="fa fa-search"></i>
                            <label name="CAPTION-HISTORY">History</label></button>
                    </div>
                    <div class="clearfix"></div>
                </div>
    ...
    <div class="row" id="panel-pallet-sku">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h4 class="pull-left" name="CAPTION-LISTSKU">List SKU</h4><button id="deletePalletDetail"
                        class="btn btn-danger pull-right" type="button" disabled><i class="fa fa-trash"></i> Hapus
                ...
                <table class="table table-striped" id="table-pallet-detail">
                    <thead>
                        <tr class="bg-primary">
                            <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-PILIH">
                                Pilih</th>
                            <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKUKODE">
                                SKU Kode</th>
                            <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SKU">
                                SKU</th>
                            <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-BRAND">
                                Brand</th>
                            <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-KEMASAN">
                                Kemasan</th>
                            <th style="text-align: center; vertical-align: middle;color:white;" name="CAPTION-SATUAN">
                                Satuan</th>
