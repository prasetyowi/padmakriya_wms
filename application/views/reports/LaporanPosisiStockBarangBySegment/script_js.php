<script type="text/javascript">
	...
	function GetLaporanStockRekapData() {
		...
		var segment = $('#filter_segment option:selected').text();

		$.ajax({
			url: "<?= base_url('WMS/LaporanTransaksi/LaporanPosisiStockBarangBySegment/GetLaporanPosisiStockBarangBySegment') ?>",
			data: {
				principle_id: $('#filter_stock_principle').val(),
				client_pt_segmen_id: $('#filter_segment').val()
			},
			type: 'POST',
			dataType: 'json',
