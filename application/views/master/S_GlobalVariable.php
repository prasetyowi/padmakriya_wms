...
<script type="text/javascript">
	...
	function isValidDateRange(monthStart, yearStart, monthEnd, yearEnd) {
		// Convert bulan dan tahun menjadi angka yang mudah dibandingkan (YYYYMM)
		const start = yearStart * 100 + monthStart;
		const end = yearEnd * 100 + monthEnd;

		// Jika bulanTahunMulai lebih besar dari bulanTahunAkhir, berarti range tidak valid
		return start <= end;
	}
