		...
		if (Data.Depo != 0) {
			...
			for (i = 0; i < Data.Depo.length; i++) {
				...
				*/
				...
				// if (isaccessible == 1) {
				// 	var img = "<?= Get_Assets_Url(); ?>vendors/leaflet/images/marker-icon.png";
				// } else {
				// 	var img = "<?= Get_Assets_Url(); ?>vendors/leaflet/images/marker-icon-unavailable.png";
				// }
				...
				// 	var marker = L.marker([depo_latitude, depo_longitude], {
				// 		icon: icon
				// 	}).addTo(map);
