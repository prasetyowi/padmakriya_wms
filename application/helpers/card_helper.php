...
function CardDashboard()
{
	...
	foreach ($data as $key => $value) {
		...
		$html .= '<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-6"><a href="javascript:void(0)" onclick="showListDataByCard(\'' . $value->modul . '\')"><div class="tile-stats"><div class="icon"><i class="' . $value->icon . '" style="color:' . random_color() . '"></i></div><div class="count" id="' . $value->modul . '">' . $value->jum . '</div><h5 name="' . $value->bahasa . '"></h5></div></a></div>';
	}
	return $html;
}
