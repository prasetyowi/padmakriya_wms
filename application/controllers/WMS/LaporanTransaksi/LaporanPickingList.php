...
class LaporanPickingList extends ParentController
{
	...
	public function __construct()
	{
		...
		$this->MenuKode = "101002008";
		$this->load->model('WMS/LaporanTransaksi/M_LaporanPickingList', 'M_LaporanPickingList');
		$this->load->model('M_Menu');
		$this->load->model('M_Function');
		$this->load->model('M_MenuAccess');
	}

	public function LaporanPickingListMenu()
	{
		$this->load->model('M_Menu');
		...
		$data['Gudang'] = $this->M_LaporanPickingList->Get_Gudang();
		$data['Principle'] = $this->M_LaporanPickingList->Get_Principle();
		$data['ClientWMS'] = $this->M_LaporanPickingList->Get_ClientWMS();
		// Kebutuhan Authority Menu 
		$this->session->set_userdata('MenuLink', str_replace(base_url(), '', current_url()));

		$this->load->view('layouts/sidebar_header', $query);
		$this->load->view('reports/LaporanTransaksi/LaporanPickingList/main', $data);
	...
	public function getDetail()
	{
		...
		$data = $this->M_LaporanPickingList->GetDetail($tgl1, $tgl2, $client_wms, $depo_id, $depo_detail_id, $principle_id, $sku_kode, $sku_nama);
