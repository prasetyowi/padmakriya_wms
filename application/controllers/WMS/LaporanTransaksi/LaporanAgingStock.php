...
class LaporanAgingStock extends MenuController
{
    ...
    public function LaporanAgingStockMenu()
    {
        ...
        $data['TipeGudang'] = $this->M_LaporanAgingStock->Get_tipe_gudang();
    ...
    public function Get_laporan_stock_aging()
    {
        ...
        $data['LaporanAgingStock'] = $this->M_LaporanAgingStock->Get_laporan_stock_aging($tglawal, $tglakhir, $client_wms_id, $principle_id, $depo_detail_id, $tipe, $tipe_gudang);
