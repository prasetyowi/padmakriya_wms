...
class LaporanStockMovement extends MenuController
{
	...
	public function LaporanStockMovementMenu()
	{
		...
		$this->load->view('reports/LaporanStockMovement/main', $data);
		$this->load->view('layouts/sidebar_footer', $data);

		$this->load->view('master/S_GlobalVariable', $data);
		$this->load->view('reports/LaporanStockMovement/script_js', $data);
	}

	public function GetLaporanStockMovementRekapData()
	{
		$draw = 50;
