...
class PermintaanPengemasanByQtyDO extends MenuController
{
	...
	public function PermintaanPengemasanByQtyDOMenu()
	{
		...
		$data['TipeGudang'] = $this->M_PermintaanPengemasanByQtyDO->GetTipeGudang();
	...
	public function getDataSearch()
	{
		...
		$data['result'] = $this->M_PermintaanPengemasanByQtyDO->getDataSearch($tgl, $tipe_do, $tipe_gudang);
		$data['pengemasan'] = $this->M_PermintaanPengemasanByQtyDO->GetListPengemasan($tgl, $tipe_do, "", "", $tipe_gudang);
	...
	public function GetListHitungKonversiPengemasan()
	{
		...
		$data = $this->M_PermintaanPengemasanByQtyDO->GetListHitungKonversiPengemasan($tgl, $tipe_do, $filter_sku_id, $tipe_gudang);
	...
	public function GetListPengemasan()
	{
		...
		$data = $this->M_PermintaanPengemasanByQtyDO->GetListPengemasan($tgl, $tipe_do, $principle, $flag, $tipe_gudang);
		echo json_encode($data);
	}
