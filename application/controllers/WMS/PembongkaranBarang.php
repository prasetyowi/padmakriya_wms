...
class PembongkaranBarang extends MenuController
{
	//a
	...
	public function delete_tr_konversi_sku_detail2_temp_by_sku_stock_id()
	{
		$detail = $this->input->post('detail');
	...
	public function batalkanData()
	{
		$tr_konversi_sku_id = $this->input->post('tr_konversi_sku_id');

		$result = $this->M_PembongkaranBarang->batalkanData($tr_konversi_sku_id);
