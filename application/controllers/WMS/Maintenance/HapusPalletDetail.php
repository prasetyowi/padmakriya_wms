...
class HapusPalletDetail extends MenuController
{
	...
	public function getData()
	{
		...
		$sql = "SELECT ROW_NUMBER ( ) OVER ( ORDER BY p.pallet_kode ASC ) AS idx, pr.principle_nama,sku.sku_kode,sku.sku_nama_produk, p.pallet_kode,rld.rak_lajur_detail_nama,
		pd.*,
		...
		FROM pallet_detail pd
			...
			left join rak_lajur_detail rld on rld.rak_lajur_detail_id = p.rak_lajur_detail_id
