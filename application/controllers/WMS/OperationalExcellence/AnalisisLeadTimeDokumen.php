...
class AnalisisLeadTimeDokumen extends ParentController
{
    ...
    public function __construct()
    {
        ...
        $this->MenuKode = "100301500";
        $this->load->model('WMS/M_AnalisisLeadTimeDokumen', 'M_AnalisisLeadTimeDokumen');
        $this->load->model('M_Menu');
        $this->load->model('M_Function');
        $this->load->model('M_MenuAccess');
    }

    public function AnalisisLeadTimeDokumenMenu()
    {
        $this->load->model('M_Menu');
        ...
        // $data['Gudang'] = $this->M_AnalisisLeadTimeDokumen->Get_Gudang();
        $data['Principle'] = $this->M_AnalisisLeadTimeDokumen->Get_Principle();
        // $data['ClientWMS'] = $this->M_AnalisisLeadTimeDokumen->Get_ClientWMS();
        $this->load->view('layouts/sidebar_header', $query);
        $this->load->view('WMS/AnalisisLeadTimeDokumen/main', $data);
        $this->load->view('layouts/sidebar_footer', $query);
        $this->load->view('master/S_GlobalVariable', $query);
        $this->load->view('WMS/AnalisisLeadTimeDokumen/script', $data);
        // $this->load->view('LaporanInformasiPallet/script', $data);
    }
    ...
    public function Get_laporan_lead_time_do()
    {
        ...
        $data = $this->M_AnalisisLeadTimeDokumen->Get_laporan_lead_time_do($tgl1, $tgl2, $depo_id, $principle_id);
    ...
    public function Get_laporan_lead_time_do_detail_so_approved()
    {
        ...
        $total_data = $this->M_AnalisisLeadTimeDokumen->Get_total_laporan_lead_time_do_detail_so_approved($tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
        $data = $this->M_AnalisisLeadTimeDokumen->Get_laporan_lead_time_do_detail_so_approved($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
    ...
    public function Get_laporan_lead_time_do_detail_so_approved_belum_punya_do_draft()
    {
        ...
        $total_data = $this->M_AnalisisLeadTimeDokumen->Get_total_laporan_lead_time_do_detail_so_approved_belum_punya_do_draft($tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
        $data = $this->M_AnalisisLeadTimeDokumen->Get_laporan_lead_time_do_detail_so_approved_belum_punya_do_draft($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
    ...
    public function Get_laporan_lead_time_do_detail_so_approved_jadi_do_draft()
    {
        ...
        $total_data = $this->M_AnalisisLeadTimeDokumen->Get_total_laporan_lead_time_do_detail_so_approved_jadi_do_draft($tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
        $data = $this->M_AnalisisLeadTimeDokumen->Get_laporan_lead_time_do_detail_so_approved_jadi_do_draft($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
    ...
    public function Get_laporan_lead_time_do_detail_do_draft_approved()
    {
        ...
        $total_data = $this->M_AnalisisLeadTimeDokumen->Get_total_laporan_lead_time_do_detail_do_draft_approved($tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
        $data = $this->M_AnalisisLeadTimeDokumen->Get_laporan_lead_time_do_detail_do_draft_approved($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
    ...
    public function Get_laporan_lead_time_do_detail_do_dilaksanakan()
    {
        ...
        $total_data = $this->M_AnalisisLeadTimeDokumen->Get_total_laporan_lead_time_do_detail_do_dilaksanakan($tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
        $data = $this->M_AnalisisLeadTimeDokumen->Get_laporan_lead_time_do_detail_do_dilaksanakan($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $depo_id, $principle_id, $tipe, $range);
    ...
    public function getDetail()
    {
        ...
        $total_data = $this->M_AnalisisLeadTimeDokumen->count_all_data($tgl1, $tgl2, $client_wms, $depo_id, $depo_detail_id, $principle_id, $sku_kode, $sku_nama, $tgl_1, $tgl_2);

        $records_filtered = $total_data;
        // $data = $this->M_AnalisisLeadTimeDokumen->GetDetail($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $client_wms, $depo_id, $depo_detail_id, $principle_id, $sku_kode, $sku_nama, $tgl_1, $tgl_2);
        $data = $this->M_AnalisisLeadTimeDokumen->GetDetailNewProcedure($start, $length, $search_value, $order_column, $order_dir, $tgl1, $tgl2, $client_wms, $depo_id, $depo_detail_id, $principle_id, $sku_kode, $sku_nama, $tgl_1, $tgl_2);
        $response = array(
            'draw' => $draw,
            'recordsTotal' => $total_data,
            'recordsFiltered' => $records_filtered,
    ...
    public function GetAnalisisLeadTimeDokumenDetailData()
    {
        $draw = 50;
        ...
        $data_laporan_stock = $this->M_AnalisisLeadTimeDokumen->Get_laporan_transaksi_stock_movement_detail($tipe_report, $tgl1, $tgl2, $tipe_transaksi, $client_wms, $depo_id, $depo_detail_id, $principle_id, $sku_id, $sku_kode, $sku_nama, $sku_stock_expired_date, $newDataStockAwal);
