...
class MenuAndSub extends MenuController
{
	...
	public function SaveNodeLayout()
	{
		...
		if ($arrMenuNode != '') {
			foreach ($arrMenuNode as $valnode) {
				...
				$res = $this->M_Menu_Node->Insertmenu_node(
					$menu_node_id,
					$menu_diagram_id,
					$menu_node_menu_kode,
					$menu_node_menu_name,
				...
				if ($arrMenuNodeDetail != '') {
					foreach ($arrMenuNodeDetail as $valnodedetail) {
						...
						if ($menu_node_menu_kode == $menu_kode) {
							...
							$res = $this->M_Menu_Node->Insertmenu_node_detail(
								$menu_node_detail_id,
								$menu_node_id,
	...
	public function GetMenuChildByMenuKode()
	{
		...
		$data['MenuDiagramDetail'] = $this->M_Menu_Node->Getmenu_diagram_detail_by_aplikasi_kode_menu_kode($aplikasi_kode, $menu_kode);
