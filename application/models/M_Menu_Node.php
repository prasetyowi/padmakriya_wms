...
class M_Menu_Node extends CI_Model
{
	...
	public function Getmenu_diagram_detail_by_aplikasi_kode_menu_kode($aplikasi_kode, $menu_kode)
	{
		$query = $this->db->query("	select a.menu_diagram_detail_urut, a.menu_diagram_detail_keterangan
									from menu_diagram_detail a
									left join menu_diagram b on a.menu_diagram_id = b.menu_diagram_id
									where b.aplikasi_kode = '$aplikasi_kode' and b.menu_diagram_menu_kode_root = '$menu_kode'");
	...
	{
		$query = $this->db->query("	select menu_node_id, menu_diagram_id, m.menu_parent, (select mw.menu_name from menu_web mw where mw.menu_kode = m.menu_parent) as menu_name_parent,
										...
										menu_node_background_color, menu_node_font_color, m.menu_link
									from menu_node as mn	
										inner join menu_web as m on m.menu_kode = mn.menu_node_menu_kode
										inner join menu_access_web as maw on maw.menu_kode = mn.menu_node_menu_kode and pengguna_grup_id = '" . $this->session->userdata("pengguna_grup_id") . "' and status_r = 1
										left join bahasa as b on b.bahasa_kode = 'CAPTION-'+ m.menu_kode
									where menu_diagram_id = '$menu_diagram_id' order by m.menu_parent, menu_node_menu_kode");
	...
	public function Insertmenu_node(
		$menu_node_id,
		$menu_diagram_id,
		$menu_node_menu_kode,
		$menu_node_menu_name,
		...
		$menu_node_shape,
		$menu_node_custom_id,
		$menu_node_background_color,
		$menu_node_font_color
	) {
	...
	public function Insertmenu_node_detail(
		$menu_node_detail_id,
		$menu_node_id,
		$menu_node_detail_keterangan_1,
		$menu_node_detail_link_1,
		$menu_node_detail_keterangan_2,
		$menu_node_detail_link_2,
		$menu_node_detail_keterangan_3,
		$menu_node_detail_link_3
	) {
