...
class M_AnalisisPengelolaanDokumen extends CI_Model
{
    ...
    public function Get_laporan_monitoring_delivery_order($tgl1, $tgl2, $client_wms_id, $principle_id, $tipe)
    {
        set_time_limit(0);
        ...
        $query_laporan =  $this->db->query("exec report_monitoring_delivery_order '$tgl1','$tgl2','$client_wms_id','" . $this->session->userdata('depo_id') . "','$principle_id'");
