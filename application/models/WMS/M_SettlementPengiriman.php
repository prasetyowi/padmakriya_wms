...
class M_SettlementPengiriman extends CI_Model
{
	...
	{
		$query = $this->db->query("select * from delivery_order_settlement where delivery_order_id in (select delivery_order_id from delivery_order where delivery_order_batch_id = '$delivery_order_batch_id')");
	...
	public function get_settlement_pengiriman_by_filter($Tgl_FDJR, $Tgl_FDJR2, $No_FDJR, $karyawan_id)
	{
		...
		$query = $this->db->query("exec proses_settlement_view '" . $this->session->userdata('depo_id') . "', '$Tgl_FDJR', '$Tgl_FDJR2', " . $karyawan_id . ", " . $No_FDJR . " ");
	...
	{
		$query = $this->db->query("exec proses_settlement_tunai '$delivery_order_batch_id'");
	...
	{
		$query = $this->db->query("exec proses_settlement_invoicevstunai '$delivery_order_batch_id'");
