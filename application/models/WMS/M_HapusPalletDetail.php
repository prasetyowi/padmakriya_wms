...
class M_HapusPalletDetail extends CI_Model
{
	...
	public function deletePalletDetailIsZero($value)
	{
		$this->db->trans_begin();
		$id = $value['pallet_detail_id'];
		$this->db->query("delete pallet_detail where pallet_detail_id = '$id'");
