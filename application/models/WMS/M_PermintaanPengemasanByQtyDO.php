...
class M_PermintaanPengemasanByQtyDO extends CI_Model
{
	...
	public function getDataSearch($tgl, $tipe, $tipe_gudang)
	{
		$wtipe = "";
	...
	public function GetListPengemasan($tgl, $tipe, $principle, $flag, $tipe_gudang)
	{
	...
	public function GetListHitungKonversiPengemasan($tgl, $tipe, $filter_sku_id, $tipe_gudang)
	{
		$filter_sku_id_str = "";
		...
		$query = $this->db->query("SELECT do.sku_id,
								...
								WHERE ss.depo_id = '$depo_id'
									  " . $wtipe . "
									  " . $tipe_gudang . ") sku_stock ON sku_stock.sku_konversi_group = do.sku_konversi_group
