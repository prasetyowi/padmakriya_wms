...
class M_Menu extends CI_Model
{
	...
	public function Getmenu_access_web($pengguna_grup_id, $menu_kode)
	{
		...
		$query = $this->db->query("	select status_r as R, status_c as C, status_u as U, status_d as D
									from menu_access_web
									where pengguna_grup_id in (select pengguna_grup_id from pengguna_depo where depo_id = '" . $this->session->userdata('depo_id') . "' and pengguna_id = '" . $this->session->userdata('pengguna_id') . "') 
										and menu_kode = '$menu_kode'");
	...
	{
		$query = $this->db->query(" exec GetMenuTree
										'" . $this->session->userdata('Mode') . "', 
										'" . $this->session->userdata('pengguna_grup_id') . "', '', 0 ");
	...
	public function GetMenu_Depo($currentpage, $pengguna_grup_id, $menuparent = "", $awalan = "")
	{
		$query = $this->db->query(" exec GetMenuTree
										'" . $this->session->userdata('Mode') . "', 
										'" . $this->session->userdata('pengguna_grup_id') . "', '', 1 ");
	...
	// 								from menu_web a 
	// 									inner join menu_access_web b on a.menu_kode = b.menu_kode 
	// 									and b.pengguna_grup_id in (select pengguna_grup_id from pengguna_depo where depo_id = '" . $this->session->userdata('depo_id') . "' and pengguna_id = '" . $this->session->userdata('pengguna_id') . "') 
	// 											and a.menu_link <> '' and b.status_r='1' 
	...
	public function Getmenu_by_menu_link_auto($menu_link)
	{
		$query = $this->db->query("	select menu_kode, menu_order_kode, tipe from menu_web where menu_link LIKE '%$menu_link%'");
